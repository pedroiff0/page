...
> [!tip] Voulez-vous venir avec moi sans visiter le site ?
> ArXiv publie un flux par catégorie: 'https: / / rss.arxiv.org / rss / cs.SE' (hit the category). Il donne à signer sur un lecteur RSS et recevoir de nouveaux titres chaque jour. Le flux est vide le week-end et les jours fériés, lorsque l'arXiv n'annonce pas les soumissions.

## Comment choisir un article à présenter
