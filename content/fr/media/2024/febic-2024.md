...
## 🗓️ A propos de l'événement
 ...
 Moi et moi [Maycon Jorge Deláqua da Silva](https://mayconjdelaqua.vercel.app/) nous représentons le IFF Bom Jésus do Itabapoana avec le projet **"[[fr/research/satellite-trail-removal|Simulando o impacto de satélites em observações astronômicas]]*sur la façon dont les satellites artificiels causent la pollution lumineuse et endommagent les observations astronomiques. Nous sommes restés dans** 3ème place dans la catégorie Grade* *, même avec le projet encore incomplet et en concurrence avec des applications plus avancées et brevetées, résultat qui nous a également créé pour la [[mctia-2025|MCTIA 2025]]à Bethléem (PA).
...
- [[fr/media/2025/mctia-2025|MCTIA 2025]]- même projet, un an plus tard, déjà 1ère place
