...
> **Professor:** Hélio Dotto Perottoni
> **Prerequisite:** Stellar Evolution
...
|---|---|---|
| Disk formation | $z\sim7$, $>11$ Gyr | Proto-Milky Way + spin-up |
| Gaia Sausage-Enceladus | $z>2$, $\sim$11–9 Gyr | Heated disk/splash + starburst + inner halo + possible warp |
| Sagittarius dSph | $2>z>0.3$, $\sim$5 Gyr | Disk stellar overdensities + increase in star formation rate |
| Magellanic Clouds | $z<0.3$, $>{\sim}3.5$ Gyr | Halo "wakes up" with first infall |
...
3. Sharing **similar kinematic properties**.
...
> [!info]- The 1957 Vatican Conference
...
- [Winter School — Galactic Archaeology](pt-br/resource/escolainverno/arqgal) — sibling minicourse, shorter in scope, on the same general topic (Portuguese only)
- [Anomaly Detection in Gaia Data](en/research/anomaly-detection) — my research uses exactly the stellar population data introduced here
