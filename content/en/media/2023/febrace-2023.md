...
## 🗓️ About the event
 ...
 It was the first time that the Itabapoana Bom Jesus campus of the IFF participated in FEBrace. I took it under the guidance of the teacher [Ana Cecília Soja](https://integra.iff.edu.br/p/ana-cecilia-soja), project **"Dynamic simulation analysis of fusion galaxy clusters"**, on dark matter from collision data between galaxy clusters. The project advanced after a review and ended up selected among the**200 finalists** of more than 3,200 registered.
