...
Anotações de leitura sobre artigos científicos relevantes para minha pesquisa em detecção de anomalias em populações estelares — sínteses próprias, não os artigos completos (direitos autorais das editoras/arXiv permanecem com os autores originais).
