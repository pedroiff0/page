---
publish: true
title: "20260722-Cosmologia-Aula01"
...
> **Cronograma:** Aula 01 (terça) · Aula 02 (quinta) · Aula 03 (sexta)
...
4. Composição do Universo e o modelo $\Lambda$CDM
...
| 1917 | Einstein propõe o primeiro modelo cosmológico relativístico: um Universo **estático**, **plano**, contendo apenas matéria, com a introdução da **constante cosmológica** $\lambda$ (originalmente para permitir um Universo estático) |
...
![Diagrama esquemático da história do Universo, do Big Bang até hoje, segundo o modelo ΛCDM.](https://commons.wikimedia.org/wiki/Special:FilePath/Schematic_diagram_of_the_history_of_the_Universe.jpg)
...
- **~68% Energia escura** ($\Lambda$, constante cosmológica) — responsável pela expansão acelerada.
...
![Mapa de todo o céu da Radiação Cósmica de Fundo, medido pelo satélite Planck — as variações de cor mostram flutuações de temperatura da ordem de uma parte em 100 mil.](https://commons.wikimedia.org/wiki/Special:FilePath/Cosmic_Microwave_Background_%28CMB%29.jpeg)

> [!tip] Por que a RCF importa tanto?
...
- **$\Lambda$ (Lambda):** a constante cosmológica, que no modelo padrão representa a **energia escura** — a componente responsável pela expansão acelerada do Universo.
...
- **$\Lambda$CDM:** modelo padrão, combinando energia escura ($\Lambda$) e matéria escura fria (CDM).
