...
**NEOs** (*Near-Earth Objects*) são asteroides e cometas cuja órbita os traz para perto da órbita terrestre (tipicamente definidos por perihélio $q < 1{,}3$ UA). São relevantes por duas razões complementares:
...
- **NEO (*Near-Earth Object*):** asteroide ou cometa com órbita próxima à da Terra (perihélio $q < 1{,}3$ UA).
