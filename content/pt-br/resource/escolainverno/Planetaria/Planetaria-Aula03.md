...
> Esta nota ainda não reflete o conteúdo real da aula — o professor não disponibilizou slides/PDF até o momento, e eu não tenho registro seguro de qual foi o tema exato. O texto abaixo é um palpite mínimo e genérico (exoplanetas/planetologia comparada, uma continuação natural de Aula 01 → Sistema Solar e Aula 02 → pequenos corpos), só para não deixar a página vazia; será substituído por notas fiéis assim que o material oficial chegar.
