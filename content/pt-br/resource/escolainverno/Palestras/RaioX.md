...
- Supernova do Colapso do Núcleo (SNcc)
  - Não se sabe
    - a massa
    - metalicidade inicial
  - Se sabe: explosão decorrente do colapso M > 8Msol
    - Remanescente: estrela de neutrôns
  ...
  - ICM
    ...
    - AGN Feedback
    - Fusão em andamento  (Bullet Cluster)
...
- Ranking de SNe
  ...
  - Grupos Fósseis
    ...
    - NGC 1132
    - XMM-Newton
    - mais supernovas tipo II (não esperado!)
    - Fusão de Galáxias ricas em gás
    - Espectros de alta resolução retirados de satélites com micro calorímetro
    - Satélite NewAthena previsto para ser lançado em 2037
    - Simulações estão sendo feitas para descobrir o potencial do satélite
    - Vai ser possível observar a banda abaixo de 2 KeV(Evolução ao satélite do XRISM)
