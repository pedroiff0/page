...
3. [Aula 03](pt-br/resource/escolainverno/computação/computacao-aula03) — *(nota provisória, aguardando material oficial)* panorama de algoritmos clássicos de aprendizado de máquina, supervisionados (regressão linear, árvores de decisão, random forest, k-NN) e não supervisionados (PCA, t-SNE, UMAP).
