---
publish: true
title: "Anotações de Quadro — Algebra Linear E Geometria Analitica I"
created: 2026-08-24
modified: 2026-08-27
cssclasses:
  - page-layout
...
Este repositório consolida as anotações detalhadas de quadro, exercícios e materiais de apoio da disciplina **Algebra Linear E Geometria Analitica I**.
...
WHERE contains(file.folder, "Anotações")
  AND contains(file.path, "algebra-linear-e-geometria-analitica-i")
