---
publish: true
title: "Anotações de Quadro — Logica Para Computacao"
created: 2026-08-24
modified: 2026-08-27
cssclasses:
  - page-layout
...
Este repositório consolida as anotações detalhadas de quadro, exercícios e materiais de apoio da disciplina **Logica Para Computacao**.
...
WHERE contains(file.folder, "Anotações")
  AND contains(file.path, "logica-para-computacao")
