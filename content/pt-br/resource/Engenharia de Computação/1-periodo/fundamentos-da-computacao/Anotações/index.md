---
publish: true
title: "Anotações de Quadro — Fundamentos Da Computacao"
created: 2026-08-24
modified: 2026-08-27
cssclasses:
  - page-layout
...
Este repositório consolida as anotações detalhadas de quadro, exercícios e materiais de apoio da disciplina **Fundamentos Da Computacao**.
...
WHERE contains(file.folder, "Anotações")
  AND contains(file.path, "fundamentos-da-computacao")
