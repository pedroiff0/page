---
publish: true
permalink: pt-br/resource/engenharia-de-computação/1-periodo/calculo-i/anotacoes/aula-03-desigualdades
title: "Aula 03: Desigualdades; — Cálculo I"
created: '2026-08-06'
modified: '2026-08-06'
encrypted: true
tags:
...
<div style="display: flex; justify-content: space-between; align-items: center; padding: 10px 16px; background: var(--light, #f8fafc); border: 1px solid var(--lightgray, #e2e8f0); border-radius: 10px; margin: 1.5rem 0;">
  <div>⬅️ <b><a href="/pt-br/resource/engenharia-de-computação/1-periodo/calculo-i/anotacoes/aula-02-conjuntos-numéricos">Aula Anterior</a></b></div>
  <div>🏠 <b><a href="/pt-br/resource/engenharia-de-computação/1-periodo/calculo-i">Anotações da Disciplina</a></b></div>
  <div>➡️ <b><a href="/pt-br/resource/engenharia-de-computação/1-periodo/calculo-i/anotacoes/aula-04-valor-absoluto">Próxima Aula</a></b></div>
</div>

> [!info] 📌 Informações da Aula & Contexto do Quadro
> - **Disciplina:** Cálculo I
> - **Tópico do Quadro:** Desigualdades;
...
### 📐 Definição Fundamental: Desigualdades;
No contexto de **Cálculo I**, o tópico de **Desigualdades;** estabelece as seguintes formulações fundamentais:
...
Desenvolva a solução analítica para a aplicação de **Desigualdades;**:
...
> Sempre verifique os limites de validade de **Desigualdades;** antes de simplificar as equações na prova!
...
```mermaid
flowchart TD
    A[Entrada: Desigualdades;] --> B[Processamento Analítico]
...
| :--- | :--- | :--- |
| **Desigualdades;** | Formulação direta de Cálculo I | Verificar condições de contorno |

---

## 📝 5. Dúvidas & Exercícios Recomendados para Casa

- [ ] Exercício 01: Resolver a lista do quadro sobre **Desigualdades;**.
