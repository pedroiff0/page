...
|------------------|---------|
| 📄 nota-01 | [[pt-br/resource/Engenharia de Computação/3-periodo/introducao-a-ciencia-dos-materiais/anotacoes/nota-01\|Acessar Anotação]] |
...
filters:
  and:
    - 'file.folder.startsWith("pt-br/resource/Engenharia de Computação/3-periodo/introducao-a-ciencia-dos-materiais/anotacoes")'
    - 'note.publish'
formulas:
