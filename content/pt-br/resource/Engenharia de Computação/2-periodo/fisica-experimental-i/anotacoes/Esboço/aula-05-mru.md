---
publish: true
permalink: pt-br/resource/engenharia-de-computação/2-periodo/fisica-experimental-i/anotacoes/aula-05-mru
title: "Aula 05: MRU; — Física Experimental I"
created: '2026-08-06'
modified: '2026-08-06'
encrypted: true
tags:
...
<div style="display: flex; justify-content: space-between; align-items: center; padding: 10px 16px; background: var(--light, #f8fafc); border: 1px solid var(--lightgray, #e2e8f0); border-radius: 10px; margin: 1.5rem 0;">
  <div>⬅️ <b><a href="/pt-br/resource/engenharia-de-computação/2-periodo/fisica-experimental-i/anotacoes/aula-04-gráficos">Aula Anterior</a></b></div>
  <div>🏠 <b><a href="/pt-br/resource/engenharia-de-computação/2-periodo/fisica-experimental-i">Anotações da Disciplina</a></b></div>
  <div>➡️ <b><a href="/pt-br/resource/engenharia-de-computação/2-periodo/fisica-experimental-i/anotacoes/aula-06-mruv-e-cálculo-de-g">Próxima Aula</a></b></div>
</div>

> [!info] 📌 Informações da Aula & Contexto do Quadro
> - **Disciplina:** Física Experimental I
> - **Tópico do Quadro:** MRU;
...
### 📐 Definição Fundamental: MRU;
No contexto de **Física Experimental I**, o tópico de **MRU;** estabelece as seguintes formulações fundamentais:
...
Desenvolva a solução analítica para a aplicação de **MRU;**:
...
> Sempre verifique os limites de validade de **MRU;** antes de simplificar as equações na prova!
...
```mermaid
flowchart TD
    A[Entrada: MRU;] --> B[Processamento Analítico]
...
| :--- | :--- | :--- |
| **MRU;** | Formulação direta de Física Experimental I | Verificar condições de contorno |

---

## 📝 5. Dúvidas & Exercícios Recomendados para Casa

- [ ] Exercício 01: Resolver a lista do quadro sobre **MRU;**.
