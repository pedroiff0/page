---
publish: true
title: "Anotações de Quadro — Algoritmos E Tecnicas De Programacao"
created: 2026-08-24
modified: 2026-08-27
cssclasses:
  - page-layout
...
Este repositório consolida as anotações detalhadas de quadro, exercícios e materiais de apoio da disciplina **Algoritmos E Tecnicas De Programacao**.
...
WHERE contains(file.folder, "Anotações")
  AND contains(file.path, "algoritmos-e-tecnicas-de-programacao")
