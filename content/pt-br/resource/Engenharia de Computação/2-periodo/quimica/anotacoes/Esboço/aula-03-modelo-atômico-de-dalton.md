---
publish: true
permalink: pt-br/resource/engenharia-de-computação/2-periodo/quimica/anotacoes/aula-03-modelo-atômico-de-dalton
title: "Aula 03: Modelo atômico de Dalton; — Química"
created: '2026-08-06'
modified: '2026-08-06'
encrypted: true
tags:
...
<div style="display: flex; justify-content: space-between; align-items: center; padding: 10px 16px; background: var(--light, #f8fafc); border: 1px solid var(--lightgray, #e2e8f0); border-radius: 10px; margin: 1.5rem 0;">
  <div>⬅️ <b><a href="/pt-br/resource/engenharia-de-computação/2-periodo/quimica/anotacoes/aula-02-esquemas-básicos-da-química-sistema-maté">Aula Anterior</a></b></div>
  <div>🏠 <b><a href="/pt-br/resource/engenharia-de-computação/2-periodo/quimica">Anotações da Disciplina</a></b></div>
  <div>➡️ <b><a href="/pt-br/resource/engenharia-de-computação/2-periodo/quimica/anotacoes/aula-04-modelo-atômico-de-thomson">Próxima Aula</a></b></div>
</div>

> [!info] 📌 Informações da Aula & Contexto do Quadro
> - **Disciplina:** Química
> - **Tópico do Quadro:** Modelo atômico de Dalton;
...
### 📐 Definição Fundamental: Modelo atômico de Dalton;
No contexto de **Química**, o tópico de **Modelo atômico de Dalton;** estabelece as seguintes formulações fundamentais:
...
Desenvolva a solução analítica para a aplicação de **Modelo atômico de Dalton;**:
...
> Sempre verifique os limites de validade de **Modelo atômico de Dalton;** antes de simplificar as equações na prova!
...
```mermaid
flowchart TD
    A[Entrada: Modelo atômico de Dalton;] --> B[Processamento Analítico]
...
| :--- | :--- | :--- |
| **Modelo atômico de Dalton;** | Formulação direta de Química | Verificar condições de contorno |

---

## 📝 5. Dúvidas & Exercícios Recomendados para Casa

- [ ] Exercício 01: Resolver a lista do quadro sobre **Modelo atômico de Dalton;**.
