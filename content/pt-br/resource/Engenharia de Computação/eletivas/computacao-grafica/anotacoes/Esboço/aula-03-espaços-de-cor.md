---
publish: true
permalink: pt-br/resource/engenharia-de-computação/eletivas/computacao-grafica/anotacoes/aula-03-espaços-de-cor
title: "Aula 03: Espaços de Cor — Computação Gráfica"
created: '2026-08-06'
modified: '2026-08-06'
encrypted: true
tags:
...
<div style="display: flex; justify-content: space-between; align-items: center; padding: 10px 16px; background: var(--light, #f8fafc); border: 1px solid var(--lightgray, #e2e8f0); border-radius: 10px; margin: 1.5rem 0;">
  <div>⬅️ <b><a href="/pt-br/resource/engenharia-de-computação/eletivas/computacao-grafica/anotacoes/aula-02-apresentação-de-imagens-usando-monitores">Aula Anterior</a></b></div>
  <div>🏠 <b><a href="/pt-br/resource/engenharia-de-computação/eletivas/computacao-grafica">Anotações da Disciplina</a></b></div>
  <div>➡️ <b><a href="/pt-br/resource/engenharia-de-computação/eletivas/computacao-grafica/anotacoes/aula-04-bibliotecas-gráficas">Próxima Aula</a></b></div>
</div>

> [!info] 📌 Informações da Aula & Contexto do Quadro
> - **Disciplina:** Computação Gráfica
> - **Tópico do Quadro:** Espaços de Cor
...
### 📐 Definição Fundamental: Espaços de Cor
No contexto de **Computação Gráfica**, o tópico de **Espaços de Cor** estabelece as seguintes formulações fundamentais:
...
Desenvolva a solução analítica para a aplicação de **Espaços de Cor**:
...
> Sempre verifique os limites de validade de **Espaços de Cor** antes de simplificar as equações na prova!
...
```mermaid
flowchart TD
    A[Entrada: Espaços de Cor] --> B[Processamento Analítico]
...
| :--- | :--- | :--- |
| **Espaços de Cor** | Formulação direta de Computação Gráfica | Verificar condições de contorno |

---

## 📝 5. Dúvidas & Exercícios Recomendados para Casa

- [ ] Exercício 01: Resolver a lista do quadro sobre **Espaços de Cor**.
