...
Disciplinas do eletivas (optativas) do curso de Engenharia de Computação.
...
- [Processamento de Sinais](processamento-de-sinais.md) — 60h, núcleo Básico.
- [Geoprocessamento](geoprocessamento.md) — 60h, núcleo Básico.
- [Modelagem Ambiental](modelagem-ambiental.md) — 60h, núcleo Básico.
- [Algoritmos Distribuídos](algoritmos-distribuidos.md) — 60h, núcleo Básico.
- [Computação Paralela e Distribuída](computacao-paralela-e-distribuida.md) — 60h, núcleo Básico.
...
- [cc\_eletivas](assets/disciplinas/eletivas/cc_eletivas.pdf)
- [ppc\_eletivas](assets/disciplinas/eletivas/ppc_eletivas.pdf)
