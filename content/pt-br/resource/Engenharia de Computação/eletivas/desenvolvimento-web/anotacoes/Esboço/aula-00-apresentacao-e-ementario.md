---
publish: true
permalink: pt-br/resource/engenharia-de-computação/eletivas/desenvolvimento-web/anotacoes/aula-00-apresentacao-e-ementario
title: "Aula 00: Apresentação da Disciplina e Ementário — Desenvolvimento Web"
created: '2026-08-06'
modified: '2026-08-06'
encrypted: true
tags:
...
<div style="display: flex; justify-content: space-between; align-items: center; padding: 10px 16px; background: var(--light, #f8fafc); border: 1px solid var(--lightgray, #e2e8f0); border-radius: 10px; margin: 1.5rem 0;">
  <div>⬅️ <b><a href="/pt-br/resource/engenharia-de-computação/eletivas/desenvolvimento-web">Aula Anterior</a></b></div>
  <div>🏠 <b><a href="/pt-br/resource/engenharia-de-computação/eletivas/desenvolvimento-web">Anotações da Disciplina</a></b></div>
  <div>➡️ <b><a href="/pt-br/resource/engenharia-de-computação/eletivas/desenvolvimento-web/anotacoes/aula-01-programação-para-web">Próxima Aula</a></b></div>
</div>

> [!info] 📌 Informações Gerais do Plano de Ensino
> - **Disciplina:** Desenvolvimento Web (`CSECBJI.79`)
...
> ### 📑 Material da Aula
> - 📄 **[Plano de Ensino Oficial em PDF](/assets/disciplinas/plano-de-ensino-csecbji.79.pdf)**
