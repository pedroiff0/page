---
publish: true
title: "Anotações de Quadro — Energia E Eficiencia Energetica"
created: 2026-08-24
modified: 2026-08-27
cssclasses:
  - page-layout
...
Este repositório consolida as anotações detalhadas de quadro, exercícios e materiais de apoio da disciplina **Energia E Eficiencia Energetica**.
...
WHERE contains(file.folder, "Anotações")
  AND contains(file.path, "energia-e-eficiencia-energetica")
