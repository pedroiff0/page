---
publish: true
title: "Anotações de Quadro — Sociedade E Tecnologia"
created: 2026-08-24
modified: 2026-08-27
cssclasses:
  - page-layout
...
Este repositório consolida as anotações detalhadas de quadro, exercícios e materiais de apoio da disciplina **Sociedade E Tecnologia**.
...
WHERE contains(file.folder, "Anotações")
  AND contains(file.path, "sociedade-e-tecnologia")
