---
publish: true
title: "Anotações de Quadro — Computacao Paralela E Distribuida"
created: 2026-08-24
modified: 2026-08-27
cssclasses:
  - page-layout
...
Este repositório consolida as anotações detalhadas de quadro, exercícios e materiais de apoio da disciplina **Computacao Paralela E Distribuida**.
...
WHERE contains(file.folder, "Anotações")
  AND contains(file.path, "computacao-paralela-e-distribuida")
