---
publish: true
title: "Anotações de Quadro — Projeto De Software Orientado A Objetos"
created: 2026-08-24
modified: 2026-08-27
cssclasses:
  - page-layout
...
Este repositório consolida as anotações detalhadas de quadro, exercícios e materiais de apoio da disciplina **Projeto De Software Orientado A Objetos**.
...
WHERE contains(file.folder, "Anotações")
  AND contains(file.path, "projeto-de-software-orientado-a-objetos")
