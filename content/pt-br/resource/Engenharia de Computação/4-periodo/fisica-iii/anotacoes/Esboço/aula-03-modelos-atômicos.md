---
publish: true
permalink: pt-br/resource/engenharia-de-computação/4-periodo/fisica-iii/anotacoes/aula-03-modelos-atômicos
title: "Aula 03: Modelos atômicos; — Física III"
created: '2026-08-06'
modified: '2026-08-06'
encrypted: true
tags:
...
<div style="display: flex; justify-content: space-between; align-items: center; padding: 10px 16px; background: var(--light, #f8fafc); border: 1px solid var(--lightgray, #e2e8f0); border-radius: 10px; margin: 1.5rem 0;">
  <div>⬅️ <b><a href="/pt-br/resource/engenharia-de-computação/4-periodo/fisica-iii/anotacoes/aula-02-conceitos-fundamentais">Aula Anterior</a></b></div>
  <div>🏠 <b><a href="/pt-br/resource/engenharia-de-computação/4-periodo/fisica-iii">Anotações da Disciplina</a></b></div>
  <div>➡️ <b><a href="/pt-br/resource/engenharia-de-computação/4-periodo/fisica-iii/anotacoes/aula-04-processos-de-eletrização">Próxima Aula</a></b></div>
</div>

> [!info] 📌 Informações da Aula & Contexto do Quadro
> - **Disciplina:** Física III
> - **Tópico do Quadro:** Modelos atômicos;
...
### 📐 Definição Fundamental: Modelos atômicos;
No contexto de **Física III**, o tópico de **Modelos atômicos;** estabelece as seguintes formulações fundamentais:
...
Desenvolva a solução analítica para a aplicação de **Modelos atômicos;**:
...
> Sempre verifique os limites de validade de **Modelos atômicos;** antes de simplificar as equações na prova!
...
```mermaid
flowchart TD
    A[Entrada: Modelos atômicos;] --> B[Processamento Analítico]
...
| :--- | :--- | :--- |
| **Modelos atômicos;** | Formulação direta de Física III | Verificar condições de contorno |

---

## 📝 5. Dúvidas & Exercícios Recomendados para Casa

- [ ] Exercício 01: Resolver a lista do quadro sobre **Modelos atômicos;**.
