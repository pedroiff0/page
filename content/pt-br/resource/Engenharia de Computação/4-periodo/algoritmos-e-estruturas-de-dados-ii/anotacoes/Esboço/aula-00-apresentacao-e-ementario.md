---
publish: true
permalink: pt-br/resource/engenharia-de-computação/4-periodo/algoritmos-e-estruturas-de-dados-ii/anotacoes/aula-00-apresentacao-e-ementario
title: "Aula 00: Apresentação da Disciplina e Ementário — Algoritmos e Estruturas de Dados II"
created: '2026-08-06'
modified: '2026-08-06'
encrypted: true
tags:
...
<div style="display: flex; justify-content: space-between; align-items: center; padding: 10px 16px; background: var(--light, #f8fafc); border: 1px solid var(--lightgray, #e2e8f0); border-radius: 10px; margin: 1.5rem 0;">
  <div>⬅️ <b><a href="/pt-br/resource/engenharia-de-computação/4-periodo/algoritmos-e-estruturas-de-dados-ii">Aula Anterior</a></b></div>
  ...
  <div>➡️ <b><a href="/pt-br/resource/engenharia-de-computação/4-periodo/algoritmos-e-estruturas-de-dados-ii/anotacoes/aula-01-ordenação-externa">Próxima Aula</a></b></div>
</div>

> [!info] 📌 Informações Gerais do Plano de Ensino
> - **Disciplina:** Algoritmos e Estruturas de Dados II (`CSECBJI.30`)
> - **Docente Responsável:** Ana Mara
...
> ### 📑 Material da Aula
> - 📄 **[Plano de Ensino Oficial em PDF](/assets/disciplinas/plano-de-ensino-csecbji.30.pdf)**
...
```mermaid
flowchart TD
    A[Aula 00: Ementário & Apresentação] --> B[Aulas Iniciais: Fundamentação Teórica]
    B --> C[Aulas Intermediárias: Práticas & Aplicações]
    C --> D[Aulas Finais: Consolidação & Avaliações]
```
