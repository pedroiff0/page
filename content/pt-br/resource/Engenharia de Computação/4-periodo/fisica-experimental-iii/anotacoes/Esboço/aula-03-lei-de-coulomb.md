---
publish: true
permalink: pt-br/resource/engenharia-de-computação/4-periodo/fisica-experimental-iii/anotacoes/aula-03-lei-de-coulomb
title: "Aula 03: Lei de Coulomb; — Física Experimental III"
created: '2026-08-06'
modified: '2026-08-06'
encrypted: true
tags:
...
<div style="display: flex; justify-content: space-between; align-items: center; padding: 10px 16px; background: var(--light, #f8fafc); border: 1px solid var(--lightgray, #e2e8f0); border-radius: 10px; margin: 1.5rem 0;">
  <div>⬅️ <b><a href="/pt-br/resource/engenharia-de-computação/4-periodo/fisica-experimental-iii/anotacoes/aula-02-processos-de-eletrização">Aula Anterior</a></b></div>
  <div>🏠 <b><a href="/pt-br/resource/engenharia-de-computação/4-periodo/fisica-experimental-iii">Anotações da Disciplina</a></b></div>
  <div>➡️ <b><a href="/pt-br/resource/engenharia-de-computação/4-periodo/fisica-experimental-iii/anotacoes/aula-04-campo-elétrico">Próxima Aula</a></b></div>
</div>

> [!info] 📌 Informações da Aula & Contexto do Quadro
> - **Disciplina:** Física Experimental III
> - **Tópico do Quadro:** Lei de Coulomb;
...
### 📐 Definição Fundamental: Lei de Coulomb;
No contexto de **Física Experimental III**, o tópico de **Lei de Coulomb;** estabelece as seguintes formulações fundamentais:
...
Desenvolva a solução analítica para a aplicação de **Lei de Coulomb;**:
...
> Sempre verifique os limites de validade de **Lei de Coulomb;** antes de simplificar as equações na prova!
...
```mermaid
flowchart TD
    A[Entrada: Lei de Coulomb;] --> B[Processamento Analítico]
...
| :--- | :--- | :--- |
| **Lei de Coulomb;** | Formulação direta de Física Experimental III | Verificar condições de contorno |

---

## 📝 5. Dúvidas & Exercícios Recomendados para Casa

- [ ] Exercício 01: Resolver a lista do quadro sobre **Lei de Coulomb;**.
