---
publish: true
title: "Anotações de Quadro — Redes De Computadores Ii"
created: 2026-08-24
modified: 2026-08-27
cssclasses:
  - page-layout
...
Este repositório consolida as anotações detalhadas de quadro, exercícios e materiais de apoio da disciplina **Redes De Computadores Ii**.
...
WHERE contains(file.folder, "Anotações")
  AND contains(file.path, "redes-de-computadores-ii")
