---
publish: true
title: "Anotações de Quadro — Microcontroladores"
created: 2026-08-24
modified: 2026-08-27
cssclasses:
  - page-layout
...
Este repositório consolida as anotações detalhadas de quadro, exercícios e materiais de apoio da disciplina **Microcontroladores**.
...
WHERE contains(file.folder, "Anotações")
  AND contains(file.path, "microcontroladores")
