...
> - **Data & Horário:** 02/11/2026 (Segunda-feira) · `16:40–19:20 (3 tempos)`
> - **Tópico Central:** Flip-Flops Disparados por Borda (SR, D, JK, T)
> - **Status das Anotações:** 🟢 Planejada & Estruturada

> [!note] 📦 Material Didático e Recursos da Aula
> ### 📑 Material de Apoio
> - 📄 **[Slides da Aula (PDF)](/assets/disciplinas/6-periodo/eletronica-digital/slides-aula-10.pdf)** — *Apresentação e notas do docente.*
...
## 📋 Sumário Interativo
- [📍 1. Anotações do Quadro: Flip-Flops Disparados por Borda (SR, D, JK, T)](#-1-anotações-do-quadro-flip-flops-disparados-por-borda-sr-d-jk-t)
...
## 📌 1. Anotações do Quadro: Flip-Flops Disparados por Borda (SR, D, JK, T)

### 📐 Fundamentação Teórica
Funcionamento interno mestre-escravo, equações características, tabelas de excitação e tempos de setup/hold.
...
Desenvolva a solução para a aplicação prática de **Flip-Flops Disparados por Borda (SR, D, JK, T)**:
...
> Sempre revise as premissas iniciais e condições de contorno de **Flip-Flops Disparados por Borda (SR, D, JK, T)** antes de simplificar as equações na prova!
...
```mermaid
flowchart TD
    A[Entrada: Flip-Flops Disparados por Borda (SR, D, JK, T)] --> B[Processamento & Análise Técnica]
...
| :--- | :--- | :--- |
| **Flip-Flops Disparados por Borda (SR, D, JK, T)** | Aplicação direta de Eletrônica Digital | Verificar restrições de contorno |

---

## 📝 5. Dúvidas & Exercícios Recomendados para Casa

- [ ] Exercício 01: Resolver as questões do quadro sobre **Flip-Flops Disparados por Borda (SR, D, JK, T)**.
