...
> - **Data & Horário:** 07/10/2026 (Quarta-feira) · `16:40–19:20 (3 tempos)`
> - **Tópico Central:** Classes Abstratas e Interfaces como Contratos de Software
> - **Status das Anotações:** 🟢 Planejada & Estruturada

> [!note] 📦 Material Didático e Recursos da Aula
> ### 📑 Material de Apoio
> - 📄 **[Slides da Aula (PDF)](/assets/disciplinas/6-periodo/programacao-orientada-a-objetos-i/slides-aula-06.pdf)** — *Apresentação e notas do docente.*
...
## 📋 Sumário Interativo
- [📍 1. Anotações do Quadro: Classes Abstratas e Interfaces como Contratos de Software](#-1-anotações-do-quadro-classes-abstratas-e-interfaces-como-contratos-de-software)
...
## 📌 1. Anotações do Quadro: Classes Abstratas e Interfaces como Contratos de Software

### 📐 Fundamentação Teórica
Diferenças entre herança de implementação e herança de interface, default methods e herança múltipla de tipos.
...
Desenvolva a solução para a aplicação prática de **Classes Abstratas e Interfaces como Contratos de Software**:
...
> Sempre revise as premissas iniciais e condições de contorno de **Classes Abstratas e Interfaces como Contratos de Software** antes de simplificar as equações na prova!
...
```mermaid
flowchart TD
    A[Entrada: Classes Abstratas e Interfaces como Contratos de Software] --> B[Processamento & Análise Técnica]
...
| :--- | :--- | :--- |
| **Classes Abstratas e Interfaces como Contratos de Software** | Aplicação direta de Programação Orientada a Objetos I | Verificar restrições de contorno |

---

## 📝 5. Dúvidas & Exercícios Recomendados para Casa

- [ ] Exercício 01: Resolver as questões do quadro sobre **Classes Abstratas e Interfaces como Contratos de Software**.
