...
> - **Data & Horário:** 09/12/2026 (Quarta-feira) · `16:40–19:20 (3 tempos)`
> - **Tópico Central:** Avaliação Prática P2 e Apresentação do Projeto Integrador
> - **Status das Anotações:** 🟢 Planejada & Estruturada

> [!note] 📦 Material Didático e Recursos da Aula
> ### 📑 Material de Apoio
> - 📄 **[Slides da Aula (PDF)](/assets/disciplinas/6-periodo/programacao-orientada-a-objetos-i/slides-aula-15.pdf)** — *Apresentação e notas do docente.*
...
## 📋 Sumário Interativo
- [📍 1. Anotações do Quadro: Avaliação Prática P2 e Apresentação do Projeto Integrador](#-1-anotações-do-quadro-avaliacao-pratica-p2-e-apresentacao-do-projeto-integrador)
...
## 📌 1. Anotações do Quadro: Avaliação Prática P2 e Apresentação do Projeto Integrador

### 📐 Fundamentação Teórica
Defesa prática do sistema desenvolvido em equipe, avaliando robustez, coleções e boas práticas OO.
...
Desenvolva a solução para a aplicação prática de **Avaliação Prática P2 e Apresentação do Projeto Integrador**:
...
> Sempre revise as premissas iniciais e condições de contorno de **Avaliação Prática P2 e Apresentação do Projeto Integrador** antes de simplificar as equações na prova!
...
```mermaid
flowchart TD
    A[Entrada: Avaliação Prática P2 e Apresentação do Projeto Integrador] --> B[Processamento & Análise Técnica]
...
| :--- | :--- | :--- |
| **Avaliação Prática P2 e Apresentação do Projeto Integrador** | Aplicação direta de Programação Orientada a Objetos I | Verificar restrições de contorno |

---

## 📝 5. Dúvidas & Exercícios Recomendados para Casa

- [ ] Exercício 01: Resolver as questões do quadro sobre **Avaliação Prática P2 e Apresentação do Projeto Integrador**.
