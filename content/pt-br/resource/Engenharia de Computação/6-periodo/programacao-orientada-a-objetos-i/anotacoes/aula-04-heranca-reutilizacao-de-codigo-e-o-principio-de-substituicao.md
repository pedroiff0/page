...
> - **Data & Horário:** 23/09/2026 (Quarta-feira) · `16:40–19:20 (3 tempos)`
> - **Tópico Central:** Herança, Reutilização de Código e o Princípio de Substituição
> - **Status das Anotações:** 🟢 Planejada & Estruturada

> [!note] 📦 Material Didático e Recursos da Aula
> ### 📑 Material de Apoio
> - 📄 **[Slides da Aula (PDF)](/assets/disciplinas/6-periodo/programacao-orientada-a-objetos-i/slides-aula-04.pdf)** — *Apresentação e notas do docente.*
...
## 📋 Sumário Interativo
- [📍 1. Anotações do Quadro: Herança, Reutilização de Código e o Princípio de Substituição](#-1-anotações-do-quadro-heranca-reutilizacao-de-codigo-e-o-principio-de-substituicao)
...
## 📌 1. Anotações do Quadro: Herança, Reutilização de Código e o Princípio de Substituição

### 📐 Fundamentação Teórica
Extensão de classes, palavra-chave super, polimorfismo por subtipagem e o Princípio de Substituição de Liskov (LSP).
...
Desenvolva a solução para a aplicação prática de **Herança, Reutilização de Código e o Princípio de Substituição**:
...
> Sempre revise as premissas iniciais e condições de contorno de **Herança, Reutilização de Código e o Princípio de Substituição** antes de simplificar as equações na prova!
...
```mermaid
flowchart TD
    A[Entrada: Herança, Reutilização de Código e o Princípio de Substituição] --> B[Processamento & Análise Técnica]
...
| :--- | :--- | :--- |
| **Herança, Reutilização de Código e o Princípio de Substituição** | Aplicação direta de Programação Orientada a Objetos I | Verificar restrições de contorno |

---

## 📝 5. Dúvidas & Exercícios Recomendados para Casa

- [ ] Exercício 01: Resolver as questões do quadro sobre **Herança, Reutilização de Código e o Princípio de Substituição**.
