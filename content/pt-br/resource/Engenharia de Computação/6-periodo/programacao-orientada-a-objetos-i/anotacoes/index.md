...
publish: true
permalink: pt-br/resource/engenharia-de-computação/6-periodo/programacao-orientada-a-objetos-i/anotacoes
---
...
filters:
  and:
    - 'file.folder.startsWith("02 - Áreas/Acadêmico/IFF - Engenharia de Computação/6-periodo/programacao-orientada-a-objetos-i/anotacoes")'
