...
> - **Data & Horário:** 25/11/2026 (Quarta-feira) · `16:40–19:20 (3 tempos)`
> - **Tópico Central:** Expressões Lambda e Streams API
> - **Status das Anotações:** 🟢 Planejada & Estruturada

> [!note] 📦 Material Didático e Recursos da Aula
> ### 📑 Material de Apoio
> - 📄 **[Slides da Aula (PDF)](/assets/disciplinas/6-periodo/programacao-orientada-a-objetos-i/slides-aula-13.pdf)** — *Apresentação e notas do docente.*
...
## 📋 Sumário Interativo
- [📍 1. Anotações do Quadro: Expressões Lambda e Streams API](#-1-anotações-do-quadro-expressoes-lambda-e-streams-api)
...
## 📌 1. Anotações do Quadro: Expressões Lambda e Streams API

### 📐 Fundamentação Teórica
Programação funcional em Java: interfaces funcionais (Predicate, Function, Consumer), map, filter, reduce e collectors.
...
Desenvolva a solução para a aplicação prática de **Expressões Lambda e Streams API**:
...
> Sempre revise as premissas iniciais e condições de contorno de **Expressões Lambda e Streams API** antes de simplificar as equações na prova!
...
```mermaid
flowchart TD
    A[Entrada: Expressões Lambda e Streams API] --> B[Processamento & Análise Técnica]
...
| :--- | :--- | :--- |
| **Expressões Lambda e Streams API** | Aplicação direta de Programação Orientada a Objetos I | Verificar restrições de contorno |

---

## 📝 5. Dúvidas & Exercícios Recomendados para Casa

- [ ] Exercício 01: Resolver as questões do quadro sobre **Expressões Lambda e Streams API**.
