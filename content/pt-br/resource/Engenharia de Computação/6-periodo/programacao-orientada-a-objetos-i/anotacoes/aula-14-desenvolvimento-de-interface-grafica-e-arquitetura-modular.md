...
> - **Data & Horário:** 02/12/2026 (Quarta-feira) · `16:40–19:20 (3 tempos)`
> - **Tópico Central:** Desenvolvimento de Interface Gráfica e Arquitetura Modular
> - **Status das Anotações:** 🟢 Planejada & Estruturada

> [!note] 📦 Material Didático e Recursos da Aula
> ### 📑 Material de Apoio
> - 📄 **[Slides da Aula (PDF)](/assets/disciplinas/6-periodo/programacao-orientada-a-objetos-i/slides-aula-14.pdf)** — *Apresentação e notas do docente.*
...
## 📋 Sumário Interativo
- [📍 1. Anotações do Quadro: Desenvolvimento de Interface Gráfica e Arquitetura Modular](#-1-anotações-do-quadro-desenvolvimento-de-interface-grafica-e-arquitetura-modular)
...
## 📌 1. Anotações do Quadro: Desenvolvimento de Interface Gráfica e Arquitetura Modular

### 📐 Fundamentação Teórica
Introdução ao JavaFX/Swing, padrão MVC desacoplado e separação entre modelo de domínio e interface.
...
Desenvolva a solução para a aplicação prática de **Desenvolvimento de Interface Gráfica e Arquitetura Modular**:
...
> Sempre revise as premissas iniciais e condições de contorno de **Desenvolvimento de Interface Gráfica e Arquitetura Modular** antes de simplificar as equações na prova!
...
```mermaid
flowchart TD
    A[Entrada: Desenvolvimento de Interface Gráfica e Arquitetura Modular] --> B[Processamento & Análise Técnica]
...
| :--- | :--- | :--- |
| **Desenvolvimento de Interface Gráfica e Arquitetura Modular** | Aplicação direta de Programação Orientada a Objetos I | Verificar restrições de contorno |

---

## 📝 5. Dúvidas & Exercícios Recomendados para Casa

- [ ] Exercício 01: Resolver as questões do quadro sobre **Desenvolvimento de Interface Gráfica e Arquitetura Modular**.
