...
> - **Data & Horário:** 02/09/2026 (Quarta-feira) · `16:40–19:20 (3 tempos)`
> - **Tópico Central:** Classes, Instanciação e Tipos por Referência vs Valor
> - **Status das Anotações:** 🟢 Planejada & Estruturada

> [!note] 📦 Material Didático e Recursos da Aula
> ### 📑 Material de Apoio
> - 📄 **[Slides da Aula (PDF)](/assets/disciplinas/6-periodo/programacao-orientada-a-objetos-i/slides-aula-01.pdf)** — *Apresentação e notas do docente.*
...
## 📋 Sumário Interativo
- [📍 1. Anotações do Quadro: Classes, Instanciação e Tipos por Referência vs Valor](#-1-anotações-do-quadro-classes-instanciacao-e-tipos-por-referencia-vs-valor)
...
## 📌 1. Anotações do Quadro: Classes, Instanciação e Tipos por Referência vs Valor

### 📐 Fundamentação Teórica
Declaração de classes, alocação no Heap vs Stack, ciclo de vida de objetos e Garbage Collection básico.
...
Desenvolva a solução para a aplicação prática de **Classes, Instanciação e Tipos por Referência vs Valor**:
...
> Sempre revise as premissas iniciais e condições de contorno de **Classes, Instanciação e Tipos por Referência vs Valor** antes de simplificar as equações na prova!
...
```mermaid
flowchart TD
    A[Entrada: Classes, Instanciação e Tipos por Referência vs Valor] --> B[Processamento & Análise Técnica]
...
| :--- | :--- | :--- |
| **Classes, Instanciação e Tipos por Referência vs Valor** | Aplicação direta de Programação Orientada a Objetos I | Verificar restrições de contorno |

---

## 📝 5. Dúvidas & Exercícios Recomendados para Casa

- [ ] Exercício 01: Resolver as questões do quadro sobre **Classes, Instanciação e Tipos por Referência vs Valor**.
