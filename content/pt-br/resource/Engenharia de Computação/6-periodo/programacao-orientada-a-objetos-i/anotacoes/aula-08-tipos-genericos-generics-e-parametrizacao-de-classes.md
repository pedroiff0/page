...
> - **Data & Horário:** 21/10/2026 (Quarta-feira) · `16:40–19:20 (3 tempos)`
> - **Tópico Central:** Tipos Genéricos (Generics) e Parametrização de Classes
> - **Status das Anotações:** 🟢 Planejada & Estruturada

> [!note] 📦 Material Didático e Recursos da Aula
> ### 📑 Material de Apoio
> - 📄 **[Slides da Aula (PDF)](/assets/disciplinas/6-periodo/programacao-orientada-a-objetos-i/slides-aula-08.pdf)** — *Apresentação e notas do docente.*
...
## 📋 Sumário Interativo
- [📍 1. Anotações do Quadro: Tipos Genéricos (Generics) e Parametrização de Classes](#-1-anotações-do-quadro-tipos-genericos-generics-e-parametrizacao-de-classes)
...
## 📌 1. Anotações do Quadro: Tipos Genéricos (Generics) e Parametrização de Classes

### 📐 Fundamentação Teórica
Classes e métodos genéricos, wildcards bounded/unbounded (? extends / ? super) e type erasure.
...
Desenvolva a solução para a aplicação prática de **Tipos Genéricos (Generics) e Parametrização de Classes**:
...
> Sempre revise as premissas iniciais e condições de contorno de **Tipos Genéricos (Generics) e Parametrização de Classes** antes de simplificar as equações na prova!
...
```mermaid
flowchart TD
    A[Entrada: Tipos Genéricos (Generics) e Parametrização de Classes] --> B[Processamento & Análise Técnica]
...
| :--- | :--- | :--- |
| **Tipos Genéricos (Generics) e Parametrização de Classes** | Aplicação direta de Programação Orientada a Objetos I | Verificar restrições de contorno |

---

## 📝 5. Dúvidas & Exercícios Recomendados para Casa

- [ ] Exercício 01: Resolver as questões do quadro sobre **Tipos Genéricos (Generics) e Parametrização de Classes**.
