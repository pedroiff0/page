...
> - **Data & Horário:** 11/11/2026 (Quarta-feira) · `16:40–19:20 (3 tempos)`
> - **Tópico Central:** Mapas e Tabelas de Dispersão
> - **Status das Anotações:** 🟢 Planejada & Estruturada

> [!note] 📦 Material Didático e Recursos da Aula
> ### 📑 Material de Apoio
> - 📄 **[Slides da Aula (PDF)](/assets/disciplinas/6-periodo/programacao-orientada-a-objetos-i/slides-aula-11.pdf)** — *Apresentação e notas do docente.*
...
## 📋 Sumário Interativo
- [📍 1. Anotações do Quadro: Mapas e Tabelas de Dispersão](#-1-anotações-do-quadro-mapas-e-tabelas-de-dispersao)
...
## 📌 1. Anotações do Quadro: Mapas e Tabelas de Dispersão

### 📐 Fundamentação Teórica
Estruturas de mapeamento: HashMap, LinkedHashMap, TreeMap, iteração sobre chaves/valores e complexidade O(1) média.
...
Desenvolva a solução para a aplicação prática de **Mapas e Tabelas de Dispersão**:
...
> Sempre revise as premissas iniciais e condições de contorno de **Mapas e Tabelas de Dispersão** antes de simplificar as equações na prova!
...
```mermaid
flowchart TD
    A[Entrada: Mapas e Tabelas de Dispersão] --> B[Processamento & Análise Técnica]
...
| :--- | :--- | :--- |
| **Mapas e Tabelas de Dispersão** | Aplicação direta de Programação Orientada a Objetos I | Verificar restrições de contorno |

---

## 📝 5. Dúvidas & Exercícios Recomendados para Casa

- [ ] Exercício 01: Resolver as questões do quadro sobre **Mapas e Tabelas de Dispersão**.
