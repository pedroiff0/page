...
> - **Data & Horário:** 28/10/2026 (Quarta-feira) · `16:40–19:20 (3 tempos)`
> - **Tópico Central:** Tratamento Robusto de Exceções
> - **Status das Anotações:** 🟢 Planejada & Estruturada

> [!note] 📦 Material Didático e Recursos da Aula
> ### 📑 Material de Apoio
> - 📄 **[Slides da Aula (PDF)](/assets/disciplinas/6-periodo/programacao-orientada-a-objetos-i/slides-aula-09.pdf)** — *Apresentação e notas do docente.*
...
## 📋 Sumário Interativo
- [📍 1. Anotações do Quadro: Tratamento Robusto de Exceções](#-1-anotações-do-quadro-tratamento-robusto-de-excecoes)
...
## 📌 1. Anotações do Quadro: Tratamento Robusto de Exceções

### 📐 Fundamentação Teórica
Hierarquia Throwable, checked vs unchecked exceptions, try-catch-finally, try-with-resources e criação de exceções customizadas.
...
Desenvolva a solução para a aplicação prática de **Tratamento Robusto de Exceções**:
...
> Sempre revise as premissas iniciais e condições de contorno de **Tratamento Robusto de Exceções** antes de simplificar as equações na prova!
...
```mermaid
flowchart TD
    A[Entrada: Tratamento Robusto de Exceções] --> B[Processamento & Análise Técnica]
...
| :--- | :--- | :--- |
| **Tratamento Robusto de Exceções** | Aplicação direta de Programação Orientada a Objetos I | Verificar restrições de contorno |

---

## 📝 5. Dúvidas & Exercícios Recomendados para Casa

- [ ] Exercício 01: Resolver as questões do quadro sobre **Tratamento Robusto de Exceções**.
