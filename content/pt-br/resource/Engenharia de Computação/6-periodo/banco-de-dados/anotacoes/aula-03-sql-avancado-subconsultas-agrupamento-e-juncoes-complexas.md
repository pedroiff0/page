...
> - **Data & Horário:** 15/09/2026 (Terça-feira) · `13:40–16:30 (3 tempos)`
> - **Tópico Central:** SQL Avançado: Subconsultas, Agrupamento e Junções Complexas
> - **Status das Anotações:** 🟢 Planejada & Estruturada

> [!note] 📦 Material Didático e Recursos da Aula
> ### 📑 Material de Apoio
> - 📄 **[Slides da Aula (PDF)](/assets/disciplinas/6-periodo/banco-de-dados/slides-aula-03.pdf)** — *Apresentação e notas do docente.*
...
## 📋 Sumário Interativo
- [📍 1. Anotações do Quadro: SQL Avançado: Subconsultas, Agrupamento e Junções Complexas](#-1-anotações-do-quadro-sql-avancado-subconsultas-agrupamento-e-juncoes-complexas)
...
## 📌 1. Anotações do Quadro: SQL Avançado: Subconsultas, Agrupamento e Junções Complexas

### 📐 Fundamentação Teórica
Expressões de tabela comuns (CTEs), funções de janela (Window Functions), GROUP BY, HAVING e subqueries correlacionadas.
...
Desenvolva a solução para a aplicação prática de **SQL Avançado: Subconsultas, Agrupamento e Junções Complexas**:
...
> Sempre revise as premissas iniciais e condições de contorno de **SQL Avançado: Subconsultas, Agrupamento e Junções Complexas** antes de simplificar as equações na prova!
...
```mermaid
flowchart TD
    A[Entrada: SQL Avançado: Subconsultas, Agrupamento e Junções Complexas] --> B[Processamento & Análise Técnica]
...
| :--- | :--- | :--- |
| **SQL Avançado: Subconsultas, Agrupamento e Junções Complexas** | Aplicação direta de Banco de Dados | Verificar restrições de contorno |

---

## 📝 5. Dúvidas & Exercícios Recomendados para Casa

- [ ] Exercício 01: Resolver as questões do quadro sobre **SQL Avançado: Subconsultas, Agrupamento e Junções Complexas**.
