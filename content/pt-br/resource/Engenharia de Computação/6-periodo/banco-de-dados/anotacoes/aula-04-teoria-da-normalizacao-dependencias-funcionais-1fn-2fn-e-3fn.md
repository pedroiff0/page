...
> - **Data & Horário:** 22/09/2026 (Terça-feira) · `13:40–16:30 (3 tempos)`
> - **Tópico Central:** Teoria da Normalização: Dependências Funcionais, 1FN, 2FN e 3FN
> - **Status das Anotações:** 🟢 Planejada & Estruturada

> [!note] 📦 Material Didático e Recursos da Aula
> ### 📑 Material de Apoio
> - 📄 **[Slides da Aula (PDF)](/assets/disciplinas/6-periodo/banco-de-dados/slides-aula-04.pdf)** — *Apresentação e notas do docente.*
...
## 📋 Sumário Interativo
- [📍 1. Anotações do Quadro: Teoria da Normalização: Dependências Funcionais, 1FN, 2FN e 3FN](#-1-anotações-do-quadro-teoria-da-normalizacao-dependencias-funcionais-1fn-2fn-e-3fn)
...
## 📌 1. Anotações do Quadro: Teoria da Normalização: Dependências Funcionais, 1FN, 2FN e 3FN

### 📐 Fundamentação Teórica
Dependência funcional total, parcial e transitiva; decomposição sem perda de informação e preservação de dependências.
...
Desenvolva a solução para a aplicação prática de **Teoria da Normalização: Dependências Funcionais, 1FN, 2FN e 3FN**:
...
> Sempre revise as premissas iniciais e condições de contorno de **Teoria da Normalização: Dependências Funcionais, 1FN, 2FN e 3FN** antes de simplificar as equações na prova!
...
```mermaid
flowchart TD
    A[Entrada: Teoria da Normalização: Dependências Funcionais, 1FN, 2FN e 3FN] --> B[Processamento & Análise Técnica]
...
| :--- | :--- | :--- |
| **Teoria da Normalização: Dependências Funcionais, 1FN, 2FN e 3FN** | Aplicação direta de Banco de Dados | Verificar restrições de contorno |

---

## 📝 5. Dúvidas & Exercícios Recomendados para Casa

- [ ] Exercício 01: Resolver as questões do quadro sobre **Teoria da Normalização: Dependências Funcionais, 1FN, 2FN e 3FN**.
