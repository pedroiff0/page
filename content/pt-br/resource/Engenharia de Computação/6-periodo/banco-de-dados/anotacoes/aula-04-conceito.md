---
publish: true
title: "Aula 04: Conceito — Banco de Dados"
created: '2026-08-06'
modified: '2026-08-06'
password: "eng232"
tags:
...
<div style="display: flex; justify-content: space-between; align-items: center; padding: 10px 16px; background: var(--light, #f8fafc); border: 1px solid var(--lightgray, #e2e8f0); border-radius: 10px; margin: 1.5rem 0;">
  <div>⬅️ <b><a href="/pt-br/resource/engenharia-de-computação/6-periodo/banco-de-dados/anotacoes/aula-03-transações">Aula Anterior</a></b></div>
  <div>🏠 <b><a href="/pt-br/resource/engenharia-de-computação/6-periodo/banco-de-dados">Anotações da Disciplina</a></b></div>
  <div>➡️ <b><a href="/pt-br/resource/engenharia-de-computação/6-periodo/banco-de-dados/anotacoes/aula-05-propriedades">Próxima Aula</a></b></div>
</div>
...
No contexto de **Banco de Dados**, o tópico de **Conceito** estabelece as seguintes formulações fundamentais:
...
| :--- | :--- | :--- |
| **Conceito** | Formulação direta de Banco de Dados | Verificar condições de contorno |
