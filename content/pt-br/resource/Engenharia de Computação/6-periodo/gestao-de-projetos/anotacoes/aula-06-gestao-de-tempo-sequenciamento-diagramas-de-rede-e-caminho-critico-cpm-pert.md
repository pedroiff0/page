...
> - **Data & Horário:** 08/10/2026 (Quinta-feira) · `14:00–17:00 / 16:40–20:10 (4 tempos)`
> - **Tópico Central:** Gestão de Tempo: Sequenciamento, Diagramas de Rede e Caminho Crítico (CPM/PERT)
> - **Status das Anotações:** 🟢 Planejada & Estruturada

> [!note] 📦 Material Didático e Recursos da Aula
> ### 📑 Material de Apoio
> - 📄 **[Slides da Aula (PDF)](/assets/disciplinas/6-periodo/gestao-de-projetos/slides-aula-06.pdf)** — *Apresentação e notas do docente.*
...
## 📋 Sumário Interativo
- [📍 1. Anotações do Quadro: Gestão de Tempo: Sequenciamento, Diagramas de Rede e Caminho Crítico (CPM/PERT)](#-1-anotações-do-quadro-gestao-de-tempo-sequenciamento-diagramas-de-rede-e-caminho-critico-cpm-pert)
...
## 📌 1. Anotações do Quadro: Gestão de Tempo: Sequenciamento, Diagramas de Rede e Caminho Crítico (CPM/PERT)

### 📐 Fundamentação Teórica
Dependências lógicas entre atividades, cálculo de folgas, determinação do Caminho Crítico (CPM) e estimativas probabilísticas PERT.
...
Desenvolva a solução para a aplicação prática de **Gestão de Tempo: Sequenciamento, Diagramas de Rede e Caminho Crítico (CPM/PERT)**:
...
> Sempre revise as premissas iniciais e condições de contorno de **Gestão de Tempo: Sequenciamento, Diagramas de Rede e Caminho Crítico (CPM/PERT)** antes de simplificar as equações na prova!
...
```mermaid
flowchart TD
    A[Entrada: Gestão de Tempo: Sequenciamento, Diagramas de Rede e Caminho Crítico (CPM/PERT)] --> B[Processamento & Análise Técnica]
...
| :--- | :--- | :--- |
| **Gestão de Tempo: Sequenciamento, Diagramas de Rede e Caminho Crítico (CPM/PERT)** | Aplicação direta de Gestão de Projetos | Verificar restrições de contorno |

---

## 📝 5. Dúvidas & Exercícios Recomendados para Casa

- [ ] Exercício 01: Resolver as questões do quadro sobre **Gestão de Tempo: Sequenciamento, Diagramas de Rede e Caminho Crítico (CPM/PERT)**.
