...
> - **Data & Horário:** 01/10/2026 (Quinta-feira) · `14:00–17:00 / 16:40–20:10 (4 tempos)`
> - **Tópico Central:** Planejamento de Escopo: Estrutura Analítica do Projeto (EAP / WBS)
> - **Status das Anotações:** 🟢 Planejada & Estruturada

> [!note] 📦 Material Didático e Recursos da Aula
> ### 📑 Material de Apoio
> - 📄 **[Slides da Aula (PDF)](/assets/disciplinas/6-periodo/gestao-de-projetos/slides-aula-05.pdf)** — *Apresentação e notas do docente.*
...
## 📋 Sumário Interativo
- [📍 1. Anotações do Quadro: Planejamento de Escopo: Estrutura Analítica do Projeto (EAP / WBS)](#-1-anotações-do-quadro-planejamento-de-escopo-estrutura-analitica-do-projeto-eap-wbs)
...
## 📌 1. Anotações do Quadro: Planejamento de Escopo: Estrutura Analítica do Projeto (EAP / WBS)

### 📐 Fundamentação Teórica
Decomposição hierárquica das entregas do projeto, dicionário da EAP, declaração de escopo e prevenção de scope creep.
...
Desenvolva a solução para a aplicação prática de **Planejamento de Escopo: Estrutura Analítica do Projeto (EAP / WBS)**:
...
> Sempre revise as premissas iniciais e condições de contorno de **Planejamento de Escopo: Estrutura Analítica do Projeto (EAP / WBS)** antes de simplificar as equações na prova!
...
```mermaid
flowchart TD
    A[Entrada: Planejamento de Escopo: Estrutura Analítica do Projeto (EAP / WBS)] --> B[Processamento & Análise Técnica]
...
| :--- | :--- | :--- |
| **Planejamento de Escopo: Estrutura Analítica do Projeto (EAP / WBS)** | Aplicação direta de Gestão de Projetos | Verificar restrições de contorno |

---

## 📝 5. Dúvidas & Exercícios Recomendados para Casa

- [ ] Exercício 01: Resolver as questões do quadro sobre **Planejamento de Escopo: Estrutura Analítica do Projeto (EAP / WBS)**.
