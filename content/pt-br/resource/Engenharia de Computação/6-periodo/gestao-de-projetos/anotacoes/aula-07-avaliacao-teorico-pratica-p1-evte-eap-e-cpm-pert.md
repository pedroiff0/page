...
> - **Data & Horário:** 15/10/2026 (Quinta-feira) · `14:00–17:00 / 16:40–20:10 (4 tempos)`
> - **Tópico Central:** Avaliação Teórico-Prática P1 (EVTE, EAP e CPM/PERT)
> - **Status das Anotações:** 🟢 Planejada & Estruturada

> [!note] 📦 Material Didático e Recursos da Aula
> ### 📑 Material de Apoio
> - 📄 **[Slides da Aula (PDF)](/assets/disciplinas/6-periodo/gestao-de-projetos/slides-aula-07.pdf)** — *Apresentação e notas do docente.*
...
## 📋 Sumário Interativo
- [📍 1. Anotações do Quadro: Avaliação Teórico-Prática P1 (EVTE, EAP e CPM/PERT)](#-1-anotações-do-quadro-avaliacao-teorico-pratica-p1-evte-eap-e-cpm-pert)
...
## 📌 1. Anotações do Quadro: Avaliação Teórico-Prática P1 (EVTE, EAP e CPM/PERT)

### 📐 Fundamentação Teórica
Avaliação formal sobre metodologia de projetos, modelagem de EAP, dimensionamento de escala e cálculo de caminho crítico.
...
Desenvolva a solução para a aplicação prática de **Avaliação Teórico-Prática P1 (EVTE, EAP e CPM/PERT)**:
...
> Sempre revise as premissas iniciais e condições de contorno de **Avaliação Teórico-Prática P1 (EVTE, EAP e CPM/PERT)** antes de simplificar as equações na prova!
...
```mermaid
flowchart TD
    A[Entrada: Avaliação Teórico-Prática P1 (EVTE, EAP e CPM/PERT)] --> B[Processamento & Análise Técnica]
...
| :--- | :--- | :--- |
| **Avaliação Teórico-Prática P1 (EVTE, EAP e CPM/PERT)** | Aplicação direta de Gestão de Projetos | Verificar restrições de contorno |

---

## 📝 5. Dúvidas & Exercícios Recomendados para Casa

- [ ] Exercício 01: Resolver as questões do quadro sobre **Avaliação Teórico-Prática P1 (EVTE, EAP e CPM/PERT)**.
