...
> - **Data & Horário:** 05/11/2026 (Quinta-feira) · `14:00–17:00 / 16:40–20:10 (4 tempos)`
> - **Tópico Central:** Métodos de Avaliação de Investimentos: Payback Simples e Descontado
> - **Status das Anotações:** 🟢 Planejada & Estruturada

> [!note] 📦 Material Didático e Recursos da Aula
> ### 📑 Material de Apoio
> - 📄 **[Slides da Aula (PDF)](/assets/disciplinas/6-periodo/gestao-de-projetos/slides-aula-10.pdf)** — *Apresentação e notas do docente.*
...
## 📋 Sumário Interativo
- [📍 1. Anotações do Quadro: Métodos de Avaliação de Investimentos: Payback Simples e Descontado](#-1-anotações-do-quadro-metodos-de-avaliacao-de-investimentos-payback-simples-e-descontado)
...
## 📌 1. Anotações do Quadro: Métodos de Avaliação de Investimentos: Payback Simples e Descontado

### 📐 Fundamentação Teórica
Cálculo do tempo de retorno do capital investido, limitações do payback simples e ajuste temporal pelo payback descontado.
...
Desenvolva a solução para a aplicação prática de **Métodos de Avaliação de Investimentos: Payback Simples e Descontado**:
...
> Sempre revise as premissas iniciais e condições de contorno de **Métodos de Avaliação de Investimentos: Payback Simples e Descontado** antes de simplificar as equações na prova!
...
```mermaid
flowchart TD
    A[Entrada: Métodos de Avaliação de Investimentos: Payback Simples e Descontado] --> B[Processamento & Análise Técnica]
...
| :--- | :--- | :--- |
| **Métodos de Avaliação de Investimentos: Payback Simples e Descontado** | Aplicação direta de Gestão de Projetos | Verificar restrições de contorno |

---

## 📝 5. Dúvidas & Exercícios Recomendados para Casa

- [ ] Exercício 01: Resolver as questões do quadro sobre **Métodos de Avaliação de Investimentos: Payback Simples e Descontado**.
