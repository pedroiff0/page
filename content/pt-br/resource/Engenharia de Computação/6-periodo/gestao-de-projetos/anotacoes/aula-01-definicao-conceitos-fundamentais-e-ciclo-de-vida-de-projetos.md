...
> - **Data & Horário:** 03/09/2026 (Quinta-feira) · `14:00–17:00 / 16:40–20:10 (4 tempos)`
> - **Tópico Central:** Definição, Conceitos Fundamentais e Ciclo de Vida de Projetos
> - **Status das Anotações:** 🟢 Planejada & Estruturada

> [!note] 📦 Material Didático e Recursos da Aula
> ### 📑 Material de Apoio
> - 📄 **[Slides da Aula (PDF)](/assets/disciplinas/6-periodo/gestao-de-projetos/slides-aula-01.pdf)** — *Apresentação e notas do docente.*
...
## 📋 Sumário Interativo
- [📍 1. Anotações do Quadro: Definição, Conceitos Fundamentais e Ciclo de Vida de Projetos](#-1-anotações-do-quadro-definicao-conceitos-fundamentais-e-ciclo-de-vida-de-projetos)
...
## 📌 1. Anotações do Quadro: Definição, Conceitos Fundamentais e Ciclo de Vida de Projetos

### 📐 Fundamentação Teórica
Definição de projeto, temporalidade, exclusividade, elaboração progressiva e o triângulo de restrições (Escopo, Tempo, Custo).
...
Desenvolva a solução para a aplicação prática de **Definição, Conceitos Fundamentais e Ciclo de Vida de Projetos**:
...
> Sempre revise as premissas iniciais e condições de contorno de **Definição, Conceitos Fundamentais e Ciclo de Vida de Projetos** antes de simplificar as equações na prova!
...
```mermaid
flowchart TD
    A[Entrada: Definição, Conceitos Fundamentais e Ciclo de Vida de Projetos] --> B[Processamento & Análise Técnica]
...
| :--- | :--- | :--- |
| **Definição, Conceitos Fundamentais e Ciclo de Vida de Projetos** | Aplicação direta de Gestão de Projetos | Verificar restrições de contorno |

---

## 📝 5. Dúvidas & Exercícios Recomendados para Casa

- [ ] Exercício 01: Resolver as questões do quadro sobre **Definição, Conceitos Fundamentais e Ciclo de Vida de Projetos**.
