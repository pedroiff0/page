...
> - **Data & Horário:** 13/11/2026 (Sexta-feira) · `13:40–16:30 (3 tempos)`
> - **Tópico Central:** Sistemas de Tipos, Inferência e Verificação Semântica
> - **Status das Anotações:** 🟢 Planejada & Estruturada

> [!note] 📦 Material Didático e Recursos da Aula
> ### 📑 Material de Apoio
> - 📄 **[Slides da Aula (PDF)](/assets/disciplinas/6-periodo/compiladores/slides-aula-11.pdf)** — *Apresentação e notas do docente.*
...
## 📋 Sumário Interativo
- [📍 1. Anotações do Quadro: Sistemas de Tipos, Inferência e Verificação Semântica](#-1-anotações-do-quadro-sistemas-de-tipos-inferencia-e-verificacao-semantica)
...
## 📌 1. Anotações do Quadro: Sistemas de Tipos, Inferência e Verificação Semântica

### 📐 Fundamentação Teórica
Regras de tipagem estática, coerção implícita de tipos, verificação de escopo e checagem de parâmetros de funções.
...
Desenvolva a solução para a aplicação prática de **Sistemas de Tipos, Inferência e Verificação Semântica**:
...
> Sempre revise as premissas iniciais e condições de contorno de **Sistemas de Tipos, Inferência e Verificação Semântica** antes de simplificar as equações na prova!
...
```mermaid
flowchart TD
    A[Entrada: Sistemas de Tipos, Inferência e Verificação Semântica] --> B[Processamento & Análise Técnica]
...
| :--- | :--- | :--- |
| **Sistemas de Tipos, Inferência e Verificação Semântica** | Aplicação direta de Compiladores | Verificar restrições de contorno |

---

## 📝 5. Dúvidas & Exercícios Recomendados para Casa

- [ ] Exercício 01: Resolver as questões do quadro sobre **Sistemas de Tipos, Inferência e Verificação Semântica**.
