...
> - **Data & Horário:** 18/09/2026 (Sexta-feira) · `13:40–16:30 (3 tempos)`
> - **Tópico Central:** Construção e Uso de Geradores Léxicos (Flex / JFlex)
> - **Status das Anotações:** 🟢 Planejada & Estruturada

> [!note] 📦 Material Didático e Recursos da Aula
> ### 📑 Material de Apoio
> - 📄 **[Slides da Aula (PDF)](/assets/disciplinas/6-periodo/compiladores/slides-aula-03.pdf)** — *Apresentação e notas do docente.*
...
## 📋 Sumário Interativo
- [📍 1. Anotações do Quadro: Construção e Uso de Geradores Léxicos (Flex / JFlex)](#-1-anotações-do-quadro-construcao-e-uso-de-geradores-lexicos-flex-jflex)
...
## 📌 1. Anotações do Quadro: Construção e Uso de Geradores Léxicos (Flex / JFlex)

### 📐 Fundamentação Teórica
Especificação de regras léxicas, tratamento de espaços, comentários, literais e geração automática de analisadores com Flex.
...
Desenvolva a solução para a aplicação prática de **Construção e Uso de Geradores Léxicos (Flex / JFlex)**:
...
> Sempre revise as premissas iniciais e condições de contorno de **Construção e Uso de Geradores Léxicos (Flex / JFlex)** antes de simplificar as equações na prova!
...
```mermaid
flowchart TD
    A[Entrada: Construção e Uso de Geradores Léxicos (Flex / JFlex)] --> B[Processamento & Análise Técnica]
...
| :--- | :--- | :--- |
| **Construção e Uso de Geradores Léxicos (Flex / JFlex)** | Aplicação direta de Compiladores | Verificar restrições de contorno |

---

## 📝 5. Dúvidas & Exercícios Recomendados para Casa

- [ ] Exercício 01: Resolver as questões do quadro sobre **Construção e Uso de Geradores Léxicos (Flex / JFlex)**.
