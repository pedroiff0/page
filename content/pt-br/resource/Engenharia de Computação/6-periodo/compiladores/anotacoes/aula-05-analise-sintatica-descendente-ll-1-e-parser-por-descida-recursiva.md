...
> - **Data & Horário:** 02/10/2026 (Sexta-feira) · `13:40–16:30 (3 tempos)`
> - **Tópico Central:** Análise Sintática Descendente: LL(1) e Parser por Descida Recursiva
> - **Status das Anotações:** 🟢 Planejada & Estruturada

> [!note] 📦 Material Didático e Recursos da Aula
> ### 📑 Material de Apoio
> - 📄 **[Slides da Aula (PDF)](/assets/disciplinas/6-periodo/compiladores/slides-aula-05.pdf)** — *Apresentação e notas do docente.*
...
## 📋 Sumário Interativo
- [📍 1. Anotações do Quadro: Análise Sintática Descendente: LL(1) e Parser por Descida Recursiva](#-1-anotações-do-quadro-analise-sintatica-descendente-ll-1-e-parser-por-descida-recursiva)
...
## 📌 1. Anotações do Quadro: Análise Sintática Descendente: LL(1) e Parser por Descida Recursiva

### 📐 Fundamentação Teórica
Cálculo de conjuntos FIRST e FOLLOW, construção de tabelas preditivas LL(1) e tratamento de recursão à esquerda.
...
Desenvolva a solução para a aplicação prática de **Análise Sintática Descendente: LL(1) e Parser por Descida Recursiva**:
...
> Sempre revise as premissas iniciais e condições de contorno de **Análise Sintática Descendente: LL(1) e Parser por Descida Recursiva** antes de simplificar as equações na prova!
...
```mermaid
flowchart TD
    A[Entrada: Análise Sintática Descendente: LL(1) e Parser por Descida Recursiva] --> B[Processamento & Análise Técnica]
...
| :--- | :--- | :--- |
| **Análise Sintática Descendente: LL(1) e Parser por Descida Recursiva** | Aplicação direta de Compiladores | Verificar restrições de contorno |

---

## 📝 5. Dúvidas & Exercícios Recomendados para Casa

- [ ] Exercício 01: Resolver as questões do quadro sobre **Análise Sintática Descendente: LL(1) e Parser por Descida Recursiva**.
