...
> - **Data & Horário:** 04/12/2026 (Sexta-feira) · `13:40–16:30 (3 tempos)`
> - **Tópico Central:** Ambientes de Tempo de Execução, Alocação de Pilha e Coleta de Lixo
> - **Status das Anotações:** 🟢 Planejada & Estruturada

> [!note] 📦 Material Didático e Recursos da Aula
> ### 📑 Material de Apoio
> - 📄 **[Slides da Aula (PDF)](/assets/disciplinas/6-periodo/compiladores/slides-aula-14.pdf)** — *Apresentação e notas do docente.*
...
## 📋 Sumário Interativo
- [📍 1. Anotações do Quadro: Ambientes de Tempo de Execução, Alocação de Pilha e Coleta de Lixo](#-1-anotações-do-quadro-ambientes-de-tempo-de-execucao-alocacao-de-pilha-e-coleta-de-lixo)
...
## 📌 1. Anotações do Quadro: Ambientes de Tempo de Execução, Alocação de Pilha e Coleta de Lixo

### 📐 Fundamentação Teórica
Layout de memória (Text, Data, Heap, Stack), registros de ativação, ponteiros de frame/pilha e gerenciamento de chamadas recursivas.
...
Desenvolva a solução para a aplicação prática de **Ambientes de Tempo de Execução, Alocação de Pilha e Coleta de Lixo**:
...
> Sempre revise as premissas iniciais e condições de contorno de **Ambientes de Tempo de Execução, Alocação de Pilha e Coleta de Lixo** antes de simplificar as equações na prova!
...
```mermaid
flowchart TD
    A[Entrada: Ambientes de Tempo de Execução, Alocação de Pilha e Coleta de Lixo] --> B[Processamento & Análise Técnica]
...
| :--- | :--- | :--- |
| **Ambientes de Tempo de Execução, Alocação de Pilha e Coleta de Lixo** | Aplicação direta de Compiladores | Verificar restrições de contorno |

---

## 📝 5. Dúvidas & Exercícios Recomendados para Casa

- [ ] Exercício 01: Resolver as questões do quadro sobre **Ambientes de Tempo de Execução, Alocação de Pilha e Coleta de Lixo**.
