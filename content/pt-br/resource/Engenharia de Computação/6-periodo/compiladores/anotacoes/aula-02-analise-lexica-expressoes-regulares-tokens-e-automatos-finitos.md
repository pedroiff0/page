...
> - **Data & Horário:** 11/09/2026 (Sexta-feira) · `13:40–16:30 (3 tempos)`
> - **Tópico Central:** Análise Léxica: Expressões Regulares, Tokens e Autômatos Finitos
> - **Status das Anotações:** 🟢 Planejada & Estruturada

> [!note] 📦 Material Didático e Recursos da Aula
> ### 📑 Material de Apoio
> - 📄 **[Slides da Aula (PDF)](/assets/disciplinas/6-periodo/compiladores/slides-aula-02.pdf)** — *Apresentação e notas do docente.*
...
## 📋 Sumário Interativo
- [📍 1. Anotações do Quadro: Análise Léxica: Expressões Regulares, Tokens e Autômatos Finitos](#-1-anotações-do-quadro-analise-lexica-expressoes-regulares-tokens-e-automatos-finitos)
...
## 📌 1. Anotações do Quadro: Análise Léxica: Expressões Regulares, Tokens e Autômatos Finitos

### 📐 Fundamentação Teórica
Alfabeto, linguagens regulares, conversão de ER para AFN (Construção de Thompson) e determinização para AFD.
...
Desenvolva a solução para a aplicação prática de **Análise Léxica: Expressões Regulares, Tokens e Autômatos Finitos**:
...
> Sempre revise as premissas iniciais e condições de contorno de **Análise Léxica: Expressões Regulares, Tokens e Autômatos Finitos** antes de simplificar as equações na prova!
...
```mermaid
flowchart TD
    A[Entrada: Análise Léxica: Expressões Regulares, Tokens e Autômatos Finitos] --> B[Processamento & Análise Técnica]
...
| :--- | :--- | :--- |
| **Análise Léxica: Expressões Regulares, Tokens e Autômatos Finitos** | Aplicação direta de Compiladores | Verificar restrições de contorno |

---

## 📝 5. Dúvidas & Exercícios Recomendados para Casa

- [ ] Exercício 01: Resolver as questões do quadro sobre **Análise Léxica: Expressões Regulares, Tokens e Autômatos Finitos**.
