...
<div style="display: flex; justify-content: space-between; align-items: center; padding: 10px 16px; background: var(--light, #f8fafc); border: 1px solid var(--lightgray, #e2e8f0); border-radius: 10px; margin: 1.5rem 0;">
  <div>⬅️ <b><a href="/pt-br/resource/engenharia-de-computação/6-periodo/compiladores">Aula Anterior</a></b></div>
...
> - **Data & Horário:** 28/08/2026 (Sexta-feira) · `13:40–16:30 (3 tempos)`
> - **Tópico Central:** Apresentação da Disciplina, Arquitetura de Tradutores e Ementa
> - **Status das Anotações:** 🟢 Planejada & Estruturada

> [!note] 📦 Material Didático e Recursos da Aula
> ### 📑 Material de Apoio
> - 📄 **[Slides da Aula (PDF)](/assets/disciplinas/6-periodo/compiladores/slides-aula-00.pdf)** — *Apresentação e notas do docente.*
...
## 📋 Sumário Interativo
- [📍 1. Anotações do Quadro: Apresentação da Disciplina, Arquitetura de Tradutores e Ementa](#-1-anotações-do-quadro-apresentacao-da-disciplina-arquitetura-de-tradutores-e-ementa)
...
## 📌 1. Anotações do Quadro: Apresentação da Disciplina, Arquitetura de Tradutores e Ementa

### 📐 Fundamentação Teórica
Visão geral do pipeline de compilação (front-end vs back-end), compiladores vs interpretadores e JIT.
...
Desenvolva a solução para a aplicação prática de **Apresentação da Disciplina, Arquitetura de Tradutores e Ementa**:
...
> Sempre revise as premissas iniciais e condições de contorno de **Apresentação da Disciplina, Arquitetura de Tradutores e Ementa** antes de simplificar as equações na prova!
...
```mermaid
flowchart TD
    A[Entrada: Apresentação da Disciplina, Arquitetura de Tradutores e Ementa] --> B[Processamento & Análise Técnica]
...
| :--- | :--- | :--- |
| **Apresentação da Disciplina, Arquitetura de Tradutores e Ementa** | Aplicação direta de Compiladores | Verificar restrições de contorno |

---

## 📝 5. Dúvidas & Exercícios Recomendados para Casa

- [ ] Exercício 01: Resolver as questões do quadro sobre **Apresentação da Disciplina, Arquitetura de Tradutores e Ementa**.
