...
> - **Data & Horário:** 06/10/2026 (Terça-feira) · `16:40–19:20 (3 tempos)`
> - **Tópico Central:** Técnicas de Codificação de Linha em Banda Básica
> - **Status das Anotações:** 🟢 Planejada & Estruturada

> [!note] 📦 Material Didático e Recursos da Aula
> ### 📑 Material de Apoio
> - 📄 **[Slides da Aula (PDF)](/assets/disciplinas/6-periodo/comunicacao-de-dados/slides-aula-06.pdf)** — *Apresentação e notas do docente.*
...
## 📋 Sumário Interativo
- [📍 1. Anotações do Quadro: Técnicas de Codificação de Linha em Banda Básica](#-1-anotações-do-quadro-tecnicas-de-codificacao-de-linha-em-banda-basica)
...
## 📌 1. Anotações do Quadro: Técnicas de Codificação de Linha em Banda Básica

### 📐 Fundamentação Teórica
Formatos NRZ-L, NRZ-I, RZ, Manchester, Differential Manchester, AMI e esquemas de substituição B8ZS/HDB3.
...
Desenvolva a solução para a aplicação prática de **Técnicas de Codificação de Linha em Banda Básica**:
...
> Sempre revise as premissas iniciais e condições de contorno de **Técnicas de Codificação de Linha em Banda Básica** antes de simplificar as equações na prova!
...
```mermaid
flowchart TD
    A[Entrada: Técnicas de Codificação de Linha em Banda Básica] --> B[Processamento & Análise Técnica]
...
| :--- | :--- | :--- |
| **Técnicas de Codificação de Linha em Banda Básica** | Aplicação direta de Comunicação de Dados | Verificar restrições de contorno |

---

## 📝 5. Dúvidas & Exercícios Recomendados para Casa

- [ ] Exercício 01: Resolver as questões do quadro sobre **Técnicas de Codificação de Linha em Banda Básica**.
