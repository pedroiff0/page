...
> - **Data & Horário:** 18/11/2026 (Quarta-feira) · `19:20–22:00 (3 tempos)`
> - **Tópico Central:** Ética na Inteligência Artificial e Automação
> - **Status das Anotações:** 🟢 Planejada & Estruturada

> [!note] 📦 Material Didático e Recursos da Aula
> ### 📑 Material de Apoio
> - 📄 **[Slides da Aula (PDF)](/assets/disciplinas/6-periodo/filosofia-da-ciencia-e-tecnologia/slides-aula-12.pdf)** — *Apresentação e notas do docente.*
...
## 📋 Sumário Interativo
- [📍 1. Anotações do Quadro: Ética na Inteligência Artificial e Automação](#-1-anotações-do-quadro-etica-na-inteligencia-artificial-e-automacao)
...
## 📌 1. Anotações do Quadro: Ética na Inteligência Artificial e Automação

### 📐 Fundamentação Teórica
Vieses algorítmicos, responsabilidade moral de sistemas autônomos, privacidade e o futuro do trabalho na computação.
...
Desenvolva a solução para a aplicação prática de **Ética na Inteligência Artificial e Automação**:
...
> Sempre revise as premissas iniciais e condições de contorno de **Ética na Inteligência Artificial e Automação** antes de simplificar as equações na prova!
...
```mermaid
flowchart TD
    A[Entrada: Ética na Inteligência Artificial e Automação] --> B[Processamento & Análise Técnica]
...
| :--- | :--- | :--- |
| **Ética na Inteligência Artificial e Automação** | Aplicação direta de Filosofia da Ciência e Tecnologia | Verificar restrições de contorno |

---

## 📝 5. Dúvidas & Exercícios Recomendados para Casa

- [ ] Exercício 01: Resolver as questões do quadro sobre **Ética na Inteligência Artificial e Automação**.
