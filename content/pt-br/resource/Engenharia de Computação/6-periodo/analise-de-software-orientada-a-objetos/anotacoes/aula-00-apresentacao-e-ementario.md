---
publish: true
title: "Aula 00: Apresentação da Disciplina e Ementário — Análise de Software Orientada a Objetos"
created: '2026-08-06'
modified: '2026-08-06'
password: "eng232"
tags:
...
<div style="display: flex; justify-content: space-between; align-items: center; padding: 10px 16px; background: var(--light, #f8fafc); border: 1px solid var(--lightgray, #e2e8f0); border-radius: 10px; margin: 1.5rem 0;">
  ...
  <div>➡️ <b><a href="/pt-br/resource/engenharia-de-computação/6-periodo/analise-de-software-orientada-a-objetos/anotacoes/aula-01-introdução">Próxima Aula</a></b></div>
</div>
...
> ### 📑 Material da Aula
> - 📄 **[Plano de Ensino Oficial em PDF](/assets/disciplinas/plano-de-ensino-CSECBJI.42.pdf)**
