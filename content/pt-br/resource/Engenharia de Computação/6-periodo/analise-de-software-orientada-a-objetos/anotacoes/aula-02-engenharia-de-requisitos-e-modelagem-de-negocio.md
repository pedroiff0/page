...
> - **Data & Horário:** 09/09/2026 (Quarta-feira) · `13:40–16:30 (3 tempos)`
> - **Tópico Central:** Engenharia de Requisitos e Modelagem de Negócio
> - **Status das Anotações:** 🟢 Planejada & Estruturada

> [!note] 📦 Material Didático e Recursos da Aula
> ### 📑 Material de Apoio
> - 📄 **[Slides da Aula (PDF)](/assets/disciplinas/6-periodo/analise-de-software-orientada-a-objetos/slides-aula-02.pdf)** — *Apresentação e notas do docente.*
...
## 📋 Sumário Interativo
- [📍 1. Anotações do Quadro: Engenharia de Requisitos e Modelagem de Negócio](#-1-anotações-do-quadro-engenharia-de-requisitos-e-modelagem-de-negocio)
...
## 📌 1. Anotações do Quadro: Engenharia de Requisitos e Modelagem de Negócio

### 📐 Fundamentação Teórica
Requisitos funcionais e não-funcionais, regras de negócio e identificação de atores no sistema.
...
Desenvolva a solução para a aplicação prática de **Engenharia de Requisitos e Modelagem de Negócio**:
...
> Sempre revise as premissas iniciais e condições de contorno de **Engenharia de Requisitos e Modelagem de Negócio** antes de simplificar as equações na prova!
...
```mermaid
flowchart TD
    A[Entrada: Engenharia de Requisitos e Modelagem de Negócio] --> B[Processamento & Análise Técnica]
...
| :--- | :--- | :--- |
| **Engenharia de Requisitos e Modelagem de Negócio** | Aplicação direta de Análise de Software Orientada a Objetos | Verificar restrições de contorno |

---

## 📝 5. Dúvidas & Exercícios Recomendados para Casa

- [ ] Exercício 01: Resolver as questões do quadro sobre **Engenharia de Requisitos e Modelagem de Negócio**.
