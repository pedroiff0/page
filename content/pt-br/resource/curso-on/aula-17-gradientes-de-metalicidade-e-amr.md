...
> **Professor:** Hélio Dotto Perottoni
> **Fonte:** slides oficiais da disciplina — "Gradientes radiais e verticais de metalicidade e Relação idade-metalicidade"
...
A explicação hoje aceita combina duas peças já vistas nesta aula: (1) a formação **inside-out** do disco (regiões internas enriquecem mais rápido, formam-se mais cedo; regiões externas enriquecem mais devagar, formam-se mais tarde) já geraria, por si só, uma relação idade-metalicidade diferente em cada raio galactocêntrico; e (2) a **migração radial** mistura estrelas de raios (e portanto históricos de enriquecimento) diferentes na mesma vizinhança observada — ampliando ainda mais a dispersão aparente da AMR local.

> [!info] O modelo "Two-Infall"
> Um dos modelos mais influentes para conciliar evolução química com a AMR observada é o **Two-Infall Model** (Chiappini et al. 1997, 2001; ver também Spitoni et al. 2021) — que propõe que o disco da Via Láctea se formou por **dois episódios distintos de queda de gás** (um para o disco espesso/halo, outro, mais tardio, para o disco fino), cada um com sua própria história de enriquecimento químico. É a mesma referência já citada nas notas em construção da Escola de Inverno sobre a estrutura da Via Láctea.
...
- **Migração radial apaga gradientes antigos:** para populações com mais de ~10 Gyr, o gradiente radial de metalicidade tende a desaparecer.
- **Formação inside-out:** regra geral também em galáxias externas (não universal) — regiões centrais enriquecem e se formam antes das externas.
