...
> **Professor:** Hélio Dotto Perottoni
> **Fonte:** slides oficiais da disciplina — "Nucleossíntese estelar, evolução estelar e enriquecimento químico do meio interestelar"
...
> [!info] O Platô de Spite
> Em gráficos de $\log N(\text{Li})$ vs. $[\text{Fe/H}]$, estrelas de halo com metalicidade muito baixa mostram um **platô** na abundância de lítio — interpretado como a abundância primordial do elemento, já que nessas estrelas o Li não teria sido destruído por processos estelares posteriores.
...
3. **Terceira dragagem** — em estrelas acima de $7\,M_\odot$; traz elementos da queima do He (incluindo produtos do processo-s) à superfície, formando **estrelas carbonadas** (tipos C, S, S/C).

> [!tip] Por que isso importa além da química
> As dragagens não são só um detalhe de composição: alteram a abundância superficial de He usada para calibrar idades de aglomerados, e mudam a distribuição espectral de energia (SED) da estrela — afetando cor e correção bolométrica observadas.

### Processo-$\alpha$ e processo-e (pico do ferro)
...
- **Dragagens (1ª, 2ª, 3ª):** mecanismos convectivos que trazem produtos de queima interna à superfície estelar, afetando abundâncias observadas, cor e idades calibradas por aglomerados.
- **Processo-e / pico do ferro:** equilíbrio estatístico nuclear em supernovas, dominado pela máxima energia de ligação do $^{56}$Fe.
