...
> **Professor:** Hélio Dotto Perottoni
> **Fonte:** slides oficiais da disciplina — "Cronologia da evolução galáctica (disco espesso, disco fino, halo e bojo)"
...
- **O disco:** órbitas extremamente **circulares**, próximas ao plano médio.
- **A barra:** órbitas extremamente **excêntricas**, também próximas ao plano médio.
- **O bojo esferoidal clássico:** órbitas excêntricas que alcançam alturas comparativamente **altas** acima do plano.
...
- **Sagittarius** — domina o halo **externo** (>30 kpc).
- **Gaia-Sausage/Enceladus** — ocupa majoritariamente o halo **interno**.
- **Orphan**, **Cetus**, **Wukong/LMS-1**, **corrente de Helmi** — outros eventos de fusão confirmados, cada um com sua própria assinatura cinemática e química.

> [!info] GSE e a origem do disco espesso: a coincidência temporal
> O merger com a GSE, ocorrido há ~10 Gyr, é hoje entendido como o próprio gatilho da formação do disco espesso: o impacto teria perturbado um disco primordial pré-existente (curso-on Aula 18), criando o que hoje vemos como disco espesso e disparando formação estelar. Uma das melhores evidências para isso vem de idades estelares: órbitas da GSE têm excentricidades extremas, e **a formação estelar cessa simultaneamente** na Via Láctea antiga e na própria GSE (Gallart et al. 2021) — um sincronismo difícil de explicar sem um evento causal comum.
...
- **Decomposição orbital do bojo (Queiroz+2021):** disco (circular), barra (excêntrica, perto do plano) e bojo esferoidal clássico (excêntrica, longe do plano) — três populações dinamicamente distintas na mesma região do céu.
- **A barra "captura", não forma, suas estrelas:** química idêntica à do disco fino/espesso prova que as estrelas da barra vieram de um disco pré-existente.
- **Warp, cutoff e flare:** os três desvios de um disco "plano e simples" observados na estrutura de larga escala da Via Láctea.
