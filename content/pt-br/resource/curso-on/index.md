...
Curso de pós-graduação do Observatório Nacional (ON), com pré-requisito de Evolução Estelar. Percorre, ao longo de um semestre, desde o conceito de população estelar simples até a dinâmica e evolução química completa da Via Láctea (ementa em 8 unidades). As oito aulas abaixo cobrem a Unidade 1 (Estrutura da Galáxia) e a Unidade 2 (Parâmetros Observacionais) por completo — a base observacional (magnitudes, distâncias, cinemática, extinção) sobre a qual as unidades seguintes de dinâmica e evolução química se apoiam.
