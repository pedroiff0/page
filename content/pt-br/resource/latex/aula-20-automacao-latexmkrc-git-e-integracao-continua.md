...
> - 📄 **[Slides LaTeX — Modelo Branco (PDF)](/assets/biblioteca/latex-escrita/slides-latex/aula-20-branco.pdf)** — *Apresentação visual oficial.*
> - 📄 **[Slides LaTeX — Modelo Preto (PDF)](/assets/biblioteca/latex-escrita/slides-latex/aula-20-preto.pdf)** — *Apresentação visual em tema escuro.*
