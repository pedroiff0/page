...
title: "Aula 02: Objetivos Geral e Específicos e Justificativa"
created: 2026-08-04
modified: 2026-08-04
tags: ['escrita-academica', 'latex', 'objetivos', 'bloom']
---

# Aula 02: Objetivos Geral e Específicos e Justificativa
...
Objetivos claros norteiam a pesquisa. A Taxonomia de Bloom oferece verbos no infinitivo ideais para dimensionar os níveis cognitivos dos objetivos específicos. A justificativa evidencia a relevância.
...
- **Rodapé Institucional Padronizado:** `Prof. Dr. Pedro Henrique Rocha de Andrade | IFF Campus Bom Jesus do Itabapoana | Curso de Escrita Acadêmica e LaTeX (80h) | Aula 02`.
...
> **[📥 Baixar Apresentação Institucional em PPTX — Aula 02: Objetivos Geral e Específicos e Justificativa](/assets/biblioteca/latex-escrita/slides-pptx/aula-02-iff-institucional.pptx)**
...
```mermaid
graph TD;
    A[Início da Pesquisa] --> B[Identificar Aula 02: Objetivos Geral e Específicos e Justificativa]
