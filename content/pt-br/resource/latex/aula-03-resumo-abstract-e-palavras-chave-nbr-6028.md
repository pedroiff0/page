...
> - 📄 **[Slides LaTeX — Modelo Branco (PDF)](/assets/biblioteca/latex-escrita/slides-latex/aula-03-branco.pdf)** — *Apresentação visual oficial.*
> - 📄 **[Slides LaTeX — Modelo Preto (PDF)](/assets/biblioteca/latex-escrita/slides-latex/aula-03-preto.pdf)** — *Apresentação visual em tema escuro.*
