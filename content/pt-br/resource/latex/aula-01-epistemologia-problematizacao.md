...
created: 2026-08-04
modified: 2026-08-04
tags: ['escrita-academica', 'latex', 'epistemologia', 'problematizacao']
---
...
O desenvolvimento de uma pesquisa começa na compreensão de como o conhecimento é construído (Epistemologia), formulando um problema de pesquisa claro e levantando hipóteses.
...
- **Rodapé Institucional Padronizado:** `Prof. Dr. Pedro Henrique Rocha de Andrade | IFF Campus Bom Jesus do Itabapoana | Curso de Escrita Acadêmica e LaTeX (80h) | Aula 01`.
...
> **[📥 Baixar Apresentação Institucional em PPTX — Aula 01: Epistemologia, Problematização e Hipóteses](/assets/biblioteca/latex-escrita/slides-pptx/aula-01-iff-institucional.pptx)**
...
A norma aplicável predominantemente neste módulo é a **NBR 14724:2011 (Estrutura Básica de Trabalhos Acadêmicos)**. 
...
**Cenário Real:** Um aluno de pós-graduação precisava estruturar seu TCC e encontrou dificuldades em aplicar a NBR 14724:2011 (Estrutura Básica de Trabalhos Acadêmicos). Ao utilizar os padrões em LaTeX e os métodos apresentados nesta aula, ele conseguiu reduzir o tempo de formatação de 20 horas para apenas 2 horas, focando no conteúdo. As aprovações do comitê de ética e a submissão para a banca seguiram sem ressalvas formativas.
...
```mermaid
graph TD;
    A[Início da Pesquisa] --> B[Identificar Aula 01: Epistemologia, Problematização e Hipóteses]
    B --> C{Adequação à NBR 14724:2011 (Estrutura Básica de Trabalhos Acadêmicos)?}
...
2. Formate os parágrafos utilizando a classe `abntex2` no LaTeX ou as configurações padrão do MS Word/LibreOffice compatíveis com a NBR 14724:2011 (Estrutura Básica de Trabalhos Acadêmicos).
3. Monte 2 slides de Beamer para apresentar seus parágrafos, aplicando o código base fornecido.

## Referências Bibliográficas

ASSOCIAÇÃO BRASILEIRA DE NORMAS TÉCNICAS. **NBR 14724:2011 (Estrutura Básica de Trabalhos Acadêmicos)**. Rio de Janeiro, ano de vigência.
