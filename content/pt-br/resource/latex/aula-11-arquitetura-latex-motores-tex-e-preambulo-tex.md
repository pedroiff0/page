...
| :--- | :--- |
| 📄 **Slides LaTeX (52 slides — Modelo Branco .pdf)** | [Acessar Slide Branco](/assets/biblioteca/latex-escrita/slides-latex/aula-11-branco.pdf) |
| 📄 **Slides LaTeX (52 slides — Modelo Preto .pdf)** | [Acessar Slide Preto](/assets/biblioteca/latex-escrita/slides-latex/aula-11-preto.pdf) |
| 📊 **Slides PPTX Institucional (Modelo Branco .pptx)** | [Acessar PPTX Branco](/assets/biblioteca/latex-escrita/slides-pptx/aula-11-branco.pptx) |
| 📊 **Slides PPTX Institucional (Modelo Preto .pptx)** | [Acessar PPTX Preto](/assets/biblioteca/latex-escrita/slides-pptx/aula-11-preto.pptx) |
| 📝 **Notas de Aula Institucionais (100% LaTeX — .pdf)** | [Acessar Notas Institucionais](/assets/biblioteca/latex-escrita/notes-latex/aula-11.pdf) |
