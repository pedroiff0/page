...
> **Estudada em detalhes na:** [**Aula 19 — Engenharia de Macros e Estrutura Interna da Classe `ifftese.cls`**](pt-br/resource/latex/aula-19-classe-ifftese-engenharia)
...
> **Estudado em detalhes na:** [**Aula 17 — Arquivo de Configuração de Metadados (`metadados.sty`)**](pt-br/resource/latex/aula-17-arquivo-metadados-sty)
...
> **Estudado em detalhes na:** [**Aula 18 — Produtividade e Macros Personalizadas (`macros.sty`)**](pt-br/resource/latex/aula-18-pacote-macros-sty)
...
> **Estudada em detalhes na:** [**Aula 21 — Slides de Defesa Institucionais em Beamer**](pt-br/resource/latex/aula-21-beamer-slides-defesa)
...
> **Estudada em detalhes na:** [**Aula 22 — Pôster Científico em LaTeX (`iffposter.cls`)**](pt-br/resource/latex/aula-22-poster-cientifico-iffposter)
...
> **Estudada em detalhes na:** [**Aula 23 — Relatórios Corporativos e Documentação Técnica**](pt-br/resource/latex/aula-23-relatorios-corporativos)
...
> **Estudados em detalhes na:** [**Aula 24 — Automação com `latexmk`, Git e Submissão**](pt-br/resource/latex/aula-24-latexmk-git-e-submissao)
