...
# Aula 17: Engenharia de Classes .cls - Anatomia da Classe Canônica `ifftese.cls` e Herança `abntex2`
...
| :--- | :--- |
| 📄 **Slides LaTeX (.pdf)** | [Acessar Slide LaTeX](/assets/biblioteca/latex-escrita/slides-latex/aula-17.pdf) |
| 📊 **Slides PPTX (.pdf)** | [Acessar Slide PPTX](/assets/biblioteca/latex-escrita/slides-pptx/aula-17.pdf) |
