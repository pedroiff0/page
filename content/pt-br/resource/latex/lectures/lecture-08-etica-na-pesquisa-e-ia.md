---
title: "Lecture 08: Ética na Pesquisa (CEP/CONEP) e Uso Ético de IA — Slides Institucionais"
publish: true
...
# Lecture 08: Ética na Pesquisa (CEP/CONEP) e Uso Ético de IA
...
> Para consultar o conteúdo teórico detalhado desta lição (Notas de Aula em Português), acesse: **[📝 Notes: Aula 08 — Ética na Pesquisa (CEP/CONEP) e Uso Ético de IA](/pt-br/resource/latex/aula-08-etica-na-pesquisa-e-ia)**.
...
> **[📥 Baixar Apresentação PPTX Institucional — Aula 08: Ética na Pesquisa (CEP/CONEP) e Uso Ético de IA](/assets/biblioteca/latex-escrita/slides-pptx/aula-08-iff-institucional.pptx)**
...
% ==============================================================================
\titulo{Aula 08: Ética na Pesquisa (CEP/CONEP) e Uso Ético de IA}
...
% ------------------------------------------------------------------------------
\begin{frame}{Roteiro da Aula 08}
    \tableofcontents
\end{frame}
...
\begin{frame}{Fundamentação Teórica e Normativa ABNT/IBGE}
    \begin{block}{Diretriz Institucional --- Integridade Científica e Plataforma Brasil}
        Submissão aos comitês de ética, TCLE, prevenção contra plágio e autoplágio.
    \end{block}
    \vspace{0.3cm}
    \textbf{Pontos-Chave da Aula 08:}
    \begin{itemize}
        \item \textbf{Alinhamento Normativo:} Obediência estrita aos padrões canônicos da ABNT e IBGE.
        \item \textbf{Rigor Metodológico:} Uso ético e transparente de Modelos de Linguagem (LLMs) como ferramentas auxiliares.
...
\begin{frame}[fragile]{Implementação Prática em LaTeX / ABNT}
    \begin{block}{Snippet de Referência --- Aula 08}
\begin{verbatim}
\textbf{Declaração de IA:} Os autores utilizaram LLMs exclusivamente para revisão gramatical.
\end{verbatim}
    \end{block}
\end{frame}
...
\begin{frame}{Síntese da Aula e Referências Normativas}
    \begin{itemize}
        \item Consolidação dos conhecimentos da Aula 08 no ecossistema IFF.
    ...
    \begin{thebibliography}{10}
        \bibitem{ref1} CONEP. Resolução CNS nº 510/2016. Brasília, 2016.
    \end{thebibliography}
\end{frame}
...
## 🔗 Navegação da Aula
- **[📝 Voltar para as Notas de Aula (Notes): Aula 08](/pt-br/resource/latex/aula-08-etica-na-pesquisa-e-ia)**
