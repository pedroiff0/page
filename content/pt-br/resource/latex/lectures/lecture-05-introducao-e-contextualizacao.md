---
title: "Lecture 05: Introdução e Contextualização do Problema — Slides Institucionais"
publish: true
...
# Lecture 05: Introdução e Contextualização do Problema
...
> Para consultar o conteúdo teórico detalhado desta lição (Notas de Aula em Português), acesse: **[📝 Notes: Aula 05 — Introdução e Contextualização do Problema](/pt-br/resource/latex/aula-05-introducao-e-contextualizacao)**.
...
> **[📥 Baixar Apresentação PPTX Institucional — Aula 05: Introdução e Contextualização do Problema](/assets/biblioteca/latex-escrita/slides-pptx/aula-05-iff-institucional.pptx)**
...
% ==============================================================================
\titulo{Aula 05: Introdução e Contextualização do Problema}
...
% ------------------------------------------------------------------------------
\begin{frame}{Roteiro da Aula 05}
    \tableofcontents
\end{frame}
...
\begin{frame}{Fundamentação Teórica e Normativa ABNT/IBGE}
    \begin{block}{Diretriz Institucional --- A Técnica do Funil Argumentativo}
        Do macro (contexto mundial/nacional) para o micro (lacuna específica da literatura e objetivo).
    \end{block}
    \vspace{0.3cm}
    \textbf{Pontos-Chave da Aula 05:}
    \begin{itemize}
        \item \textbf{Alinhamento Normativo:} Obediência estrita aos padrões canônicos da ABNT e IBGE.
        \item \textbf{Rigor Metodológico:} Como encadear parágrafos para demonstrar o Research Gap de forma clara e rigorosa.
...
\begin{frame}[fragile]{Implementação Prática em LaTeX / ABNT}
    \begin{block}{Snippet de Referência --- Aula 05}
\begin{verbatim}
\chapter{Introdução} \section{Contextualização do Problema} ...
\end{verbatim}
    \end{block}
\end{frame}
...
\begin{frame}{Síntese da Aula e Referências Normativas}
    \begin{itemize}
        \item Consolidação dos conhecimentos da Aula 05 no ecossistema IFF.
    ...
    \begin{thebibliography}{10}
        \bibitem{ref1} BOOTH, W. C. et al. A arte da pesquisa. Martins Fontes, 2008.
    \end{thebibliography}
\end{frame}
...
## 🔗 Navegação da Aula
- **[📝 Voltar para as Notas de Aula (Notes): Aula 05](/pt-br/resource/latex/aula-05-introducao-e-contextualizacao)**
