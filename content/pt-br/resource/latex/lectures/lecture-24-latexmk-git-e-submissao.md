---
title: "Lecture 24: Automação (latexmk), Git e Checklist de Submissão — Slides Institucionais"
publish: true
...
# Lecture 24: Automação (latexmk), Git e Checklist de Submissão
...
> Para consultar o conteúdo teórico detalhado desta lição (Notas de Aula em Português), acesse: **[📝 Notes: Aula 24 — Automação (latexmk), Git e Checklist de Submissão](/pt-br/resource/latex/aula-24-latexmk-git-e-submissao)**.
...
> **[📥 Baixar Apresentação PPTX Institucional — Aula 24: Automação (latexmk), Git e Checklist de Submissão](/assets/biblioteca/latex-escrita/slides-pptx/aula-24-iff-institucional.pptx)**
...
## 🔗 Navegação da Aula
- **[📝 Voltar para as Notas de Aula (Notes): Aula 24](/pt-br/resource/latex/aula-24-latexmk-git-e-submissao)**
