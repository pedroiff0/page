---
title: "Lecture 04: Dedicatória, Agradecimentos e Epígrafe — Slides Institucionais"
publish: true
...
# Lecture 04: Dedicatória, Agradecimentos e Epígrafe
...
> Para consultar o conteúdo teórico detalhado desta lição (Notas de Aula em Português), acesse: **[📝 Notes: Aula 04 — Dedicatória, Agradecimentos e Epígrafe](/pt-br/resource/latex/aula-04-dedicatoria-agradecimentos-epigrafe)**.
...
> **[📥 Baixar Apresentação PPTX Institucional — Aula 04: Dedicatória, Agradecimentos e Epígrafe](/assets/biblioteca/latex-escrita/slides-pptx/aula-04-iff-institucional.pptx)**
...
% ==============================================================================
\titulo{Aula 04: Dedicatória, Agradecimentos e Epígrafe}
...
% ------------------------------------------------------------------------------
\begin{frame}{Roteiro da Aula 04}
    \tableofcontents
\end{frame}
...
\begin{frame}{Fundamentação Teórica e Normativa ABNT/IBGE}
    \begin{block}{Diretriz Institucional --- Elementos Pré-Textuais Opcionais (NBR 14724)}
        Apesar de opcionais, expressam a jornada ética e institucional do pesquisador com sobriedade.
    \end{block}
    \vspace{0.3cm}
    \textbf{Pontos-Chave da Aula 04:}
    \begin{itemize}
        \item \textbf{Alinhamento Normativo:} Obediência estrita aos padrões canônicos da ABNT e IBGE.
        \item \textbf{Rigor Metodológico:} Diferenciação formal entre dedicatória, agradecimentos a agências de fomento e epígrafe.
...
\begin{frame}[fragile]{Implementação Prática em LaTeX / ABNT}
    \begin{block}{Snippet de Referência --- Aula 04}
\begin{verbatim}
\imprimirdedicatoria{Este trabalho é dedicado a...} \imprimirepigrafe{Citacao...}{Autor}
\end{verbatim}
    \end{block}
\end{frame}
...
\begin{frame}{Síntese da Aula e Referências Normativas}
    \begin{itemize}
        \item Consolidação dos conhecimentos da Aula 04 no ecossistema IFF.
    ...
    \begin{thebibliography}{10}
        \bibitem{ref1} ABNT. NBR 14724: Informação e documentação - Trabalhos acadêmicos. 2011.
    \end{thebibliography}
\end{frame}
...
## 🔗 Navegação da Aula
- **[📝 Voltar para as Notas de Aula (Notes): Aula 04](/pt-br/resource/latex/aula-04-dedicatoria-agradecimentos-epigrafe)**
