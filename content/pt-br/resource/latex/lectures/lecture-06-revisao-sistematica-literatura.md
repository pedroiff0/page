---
title: "Lecture 06: Revisão Sistemática da Literatura (PRISMA) — Slides Institucionais"
publish: true
...
# Lecture 06: Revisão Sistemática da Literatura (PRISMA)
...
> Para consultar o conteúdo teórico detalhado desta lição (Notas de Aula em Português), acesse: **[📝 Notes: Aula 06 — Revisão Sistemática da Literatura (PRISMA)](/pt-br/resource/latex/aula-06-revisao-sistematica-literatura)**.
...
> **[📥 Baixar Apresentação PPTX Institucional — Aula 06: Revisão Sistemática da Literatura (PRISMA)](/assets/biblioteca/latex-escrita/slides-pptx/aula-06-iff-institucional.pptx)**
...
## 🔗 Navegação da Aula
- **[📝 Voltar para as Notas de Aula (Notes): Aula 06](/pt-br/resource/latex/aula-06-revisao-sistematica-literatura)**
