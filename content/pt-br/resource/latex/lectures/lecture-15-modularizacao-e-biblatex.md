---
title: "Lecture 15: Modularização do Projeto e BibLaTeX/Biber — Slides Institucionais"
publish: true
...
# Lecture 15: Modularização do Projeto e BibLaTeX/Biber
...
> Para consultar o conteúdo teórico detalhado desta lição (Notas de Aula em Português), acesse: **[📝 Notes: Aula 15 — Modularização do Projeto e BibLaTeX/Biber](/pt-br/resource/latex/aula-15-modularizacao-e-biblatex)**.
...
> **[📥 Baixar Apresentação PPTX Institucional — Aula 15: Modularização do Projeto e BibLaTeX/Biber](/assets/biblioteca/latex-escrita/slides-pptx/aula-15-iff-institucional.pptx)**
...
## 🔗 Navegação da Aula
- **[📝 Voltar para as Notas de Aula (Notes): Aula 15](/pt-br/resource/latex/aula-15-modularizacao-e-biblatex)**
