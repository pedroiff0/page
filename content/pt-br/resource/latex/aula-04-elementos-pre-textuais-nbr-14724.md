...
| :--- | :--- |
| 📄 **Slides LaTeX (52 slides — Modelo Branco .pdf)** | [Acessar Slide Branco](/assets/biblioteca/latex-escrita/slides-latex/aula-04-branco.pdf) |
| 📄 **Slides LaTeX (52 slides — Modelo Preto .pdf)** | [Acessar Slide Preto](/assets/biblioteca/latex-escrita/slides-latex/aula-04-preto.pdf) |
| 📊 **Slides PPTX Institucional (Modelo Branco .pptx)** | [Acessar PPTX Branco](/assets/biblioteca/latex-escrita/slides-pptx/aula-04-branco.pptx) |
| 📊 **Slides PPTX Institucional (Modelo Preto .pptx)** | [Acessar PPTX Preto](/assets/biblioteca/latex-escrita/slides-pptx/aula-04-preto.pptx) |
| 📝 **Notas de Aula Institucionais (100% LaTeX — .pdf)** | [Acessar Notas Institucionais](/assets/biblioteca/latex-escrita/notes-latex/aula-04.pdf) |
...
```mermaid
sequenceDiagram
    participant C as Capa Ext.
    participant FR as Folha de Rosto e Aprovação
    participant O as Elementos Festivos Pessoais Específicos
    participant R as Os Resumos e Listas Técnicas
    participant S as Sumário (O Coroamento Final)
    
    C->>FR: Elementos Visuais e Identificadores Introdutórios Obrigatórios Base
    FR->>O: Entrada Nos Meandros de Atribuição Meritória e Subjetividade Restrita (Opcional)
    O->>R: Apresentação Científica e Diretriz Técnica Basilar Obrigatória Regrada
    R->>S: A Enunciação Estrutural Geral que Precede Efetivamente o Texto Introdutório Iminente
```
