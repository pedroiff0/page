...
% ==============================================================================
\titulo{Aula 03: Resumo, Abstract e Palavras-Chave (NBR 6028)}
...
% ------------------------------------------------------------------------------
\begin{frame}{Roteiro da Aula 03}
    \tableofcontents
\end{frame}
...
\begin{frame}{Fundamentação Teórica e Normativa ABNT/IBGE}
    \begin{block}{Diretriz Institucional --- Normativa ABNT NBR 6028:2021}
        O resumo informativo (150 a 500 palavras) deve conter contexto, objetivo, método, resultados e conclusão.
    \end{block}
    \vspace{0.3cm}
    \textbf{Pontos-Chave da Aula 03:}
    \begin{itemize}
        \item \textbf{Alinhamento Normativo:} Obediência estrita aos padrões canônicos da ABNT e IBGE.
        \item \textbf{Rigor Metodológico:} Uso de vocabulários controlados (DeCS/IEEE/VOC) para indexação precisa.
...
\begin{frame}[fragile]{Implementação Prática em LaTeX / ABNT}
    \begin{block}{Snippet de Referência --- Aula 03}
\begin{verbatim}
\begin{abstract} ... \end{abstract} \keywords{LaTeX; ABNT; TCC; ifftese.}
\end{verbatim}
    \end{block}
\end{frame}
...
\begin{frame}{Síntese da Aula e Referências Normativas}
    \begin{itemize}
        \item Consolidação dos conhecimentos da Aula 03 no ecossistema IFF.
    ...
    \begin{thebibliography}{10}
        \bibitem{ref1} ABNT. NBR 6028: Informação e documentação - Resumo - Apresentação. 2021.
    \end{thebibliography}
\end{frame}
