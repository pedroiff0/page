...
- [Modelagem de Dados](pt-br/classes/5-periodo/modelagem-de-dados) — o projeto conceitual que antecede o banco: entidades, relacionamentos e normalização.
- [Banco de Dados](pt-br/classes/6-periodo/banco-de-dados) — a disciplina central: SQL, transações, índices e a prática com SGBDs reais.
