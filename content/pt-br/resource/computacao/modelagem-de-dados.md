...
- [Modelagem de Dados](pt-br/classes/5-periodo/modelagem-de-dados) — a disciplina que este guia acompanha diretamente: ER, mapeamento e normalização.
- [Banco de Dados](pt-br/classes/6-periodo/banco-de-dados) — onde o modelo vira sistema: SQL, transações e a implementação de tudo que foi projetado aqui.
