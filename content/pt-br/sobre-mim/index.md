...
Sou Pedro Henrique, estudante de Engenharia de Computação no [Instituto Federal Fluminense](https://portal1.iff.edu.br/), em Bom Jesus do Itabapoana, no interior do Rio de Janeiro, Brasil. Desde 2022, venho construindo uma ponte entre **engenharia de computação** e **astronomia**, trabalhando em projetos de pesquisa que exploram populações estelares e a estrutura da Via Láctea.
...
<svg viewBox="0 0 1310 940" width="100%" height="auto" xmlns="http://www.w3.org/2000/svg" style="max-width: 100%; border-radius: 12px; background: var(--light); padding: 12px; border: 1px solid var(--lightgray); box-sizing: border-box;">
  <defs>
    <marker id="arrow" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
      <path d="M 0 0 L 10 5 L 0 10 z" fill="var(--gray)"/>
    </marker>
  </defs>
  <line x1="670.0" y1="495.0" x2="220.0" y2="240.0" stroke="var(--gray)" stroke-width="2.5" stroke-dasharray="6,4" opacity="0.6" marker-end="url(#arrow)"/>
<line x1="670.0" y1="495.0" x2="1090.0" y2="240.0" stroke="var(--gray)" stroke-width="2.5" stroke-dasharray="6,4" opacity="0.6" marker-end="url(#arrow)"/>
<line x1="670.0" y1="495.0" x2="1090.0" y2="720.0" stroke="var(--gray)" stroke-width="2.5" stroke-dasharray="6,4" opacity="0.6" marker-end="url(#arrow)"/>
<line x1="670.0" y1="495.0" x2="220.0" y2="720.0" stroke="var(--gray)" stroke-width="2.5" stroke-dasharray="6,4" opacity="0.6" marker-end="url(#arrow)"/>
<line x1="670.0" y1="495.0" x2="660.0" y2="140.0" stroke="var(--gray)" stroke-width="2.5" stroke-dasharray="6,4" opacity="0.6" marker-end="url(#arrow)"/>
<line x1="670.0" y1="495.0" x2="660.0" y2="800.0" stroke="var(--gray)" stroke-width="2.5" stroke-dasharray="6,4" opacity="0.6" marker-end="url(#arrow)"/>
