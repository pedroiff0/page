...
## 🗓️ Acerca del evento
 ...
 Fui organizador del evento, que priorizó protagonismo estudiantil: minicursos de arte digital (ibisPaint X) y criptografía, competiciones de e-sports (Valorant, Counter-Strike, FIFA), un hackathon para desarrollar un software de monitoreo de plazas de estacionamiento, y una rueda de conversación sobre mujeres en la computación. Como destaque en la época, la mayor parte de las actividades fue realizada por estudiantes, no por profesores, para mostrar en la práctica los beneficios del aprendizaje entre pares.
