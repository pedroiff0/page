...
> - **Data & Horário:** 24/11/2026 (Terça-feira) · `16:40–19:20 (3 tempos)`
> - **Tópico Central:** Protocolos de Janela Deslizante: Go-Back-N e Selective Repeat
> - **Status das Anotações:** 🟢 Planejada & Estruturada

> [!note] 📦 Material Didático e Recursos da Aula
> ### 📑 Material de Apoio
> - 📄 **[Slides da Aula (PDF)](/assets/disciplinas/6-periodo/comunicacao-de-dados/slides-aula-13.pdf)** — *Apresentação e notas do docente.*
...
## 📋 Sumário Interativo
- [📍 1. Anotações do Quadro: Protocolos de Janela Deslizante: Go-Back-N e Selective Repeat](#-1-anotações-do-quadro-protocolos-de-janela-deslizante-go-back-n-e-selective-repeat)
...
## 📌 1. Anotações do Quadro: Protocolos de Janela Deslizante: Go-Back-N e Selective Repeat

### 📐 Fundamentação Teórica
Eficiência de canal sob alto atraso produto-largura de banda, retransmissão cumulativa vs seletiva e temporizadores.
...
Desenvolva a solução para a aplicação prática de **Protocolos de Janela Deslizante: Go-Back-N e Selective Repeat**:
...
> Sempre revise as premissas iniciais e condições de contorno de **Protocolos de Janela Deslizante: Go-Back-N e Selective Repeat** antes de simplificar as equações na prova!
...
```mermaid
flowchart TD
    A[Entrada: Protocolos de Janela Deslizante: Go-Back-N e Selective Repeat] --> B[Processamento & Análise Técnica]
...
| :--- | :--- | :--- |
| **Protocolos de Janela Deslizante: Go-Back-N e Selective Repeat** | Aplicação direta de Comunicação de Dados | Verificar restrições de contorno |

---

## 📝 5. Dúvidas & Exercícios Recomendados para Casa

- [ ] Exercício 01: Resolver as questões do quadro sobre **Protocolos de Janela Deslizante: Go-Back-N e Selective Repeat**.
