...
> - **Data & Horário:** 15/09/2026 (Terça-feira) · `16:40–19:20 (3 tempos)`
> - **Tópico Central:** Capacidade de Canal: Teoremas de Nyquist e Shannon-Hartley
> - **Status das Anotações:** 🟢 Planejada & Estruturada

> [!note] 📦 Material Didático e Recursos da Aula
> ### 📑 Material de Apoio
> - 📄 **[Slides da Aula (PDF)](/assets/disciplinas/6-periodo/comunicacao-de-dados/slides-aula-03.pdf)** — *Apresentação e notas do docente.*
...
## 📋 Sumário Interativo
- [📍 1. Anotações do Quadro: Capacidade de Canal: Teoremas de Nyquist e Shannon-Hartley](#-1-anotações-do-quadro-capacidade-de-canal-teoremas-de-nyquist-e-shannon-hartley)
...
## 📌 1. Anotações do Quadro: Capacidade de Canal: Teoremas de Nyquist e Shannon-Hartley

### 📐 Fundamentação Teórica
Taxa máxima em canal sem ruído (C = 2B log2 M) e limite teórico sob ruído branco gaussiano (C = B log2(1 + SNR)).
...
Desenvolva a solução para a aplicação prática de **Capacidade de Canal: Teoremas de Nyquist e Shannon-Hartley**:
...
> Sempre revise as premissas iniciais e condições de contorno de **Capacidade de Canal: Teoremas de Nyquist e Shannon-Hartley** antes de simplificar as equações na prova!
...
```mermaid
flowchart TD
    A[Entrada: Capacidade de Canal: Teoremas de Nyquist e Shannon-Hartley] --> B[Processamento & Análise Técnica]
...
| :--- | :--- | :--- |
| **Capacidade de Canal: Teoremas de Nyquist e Shannon-Hartley** | Aplicação direta de Comunicação de Dados | Verificar restrições de contorno |

---

## 📝 5. Dúvidas & Exercícios Recomendados para Casa

- [ ] Exercício 01: Resolver as questões do quadro sobre **Capacidade de Canal: Teoremas de Nyquist e Shannon-Hartley**.
