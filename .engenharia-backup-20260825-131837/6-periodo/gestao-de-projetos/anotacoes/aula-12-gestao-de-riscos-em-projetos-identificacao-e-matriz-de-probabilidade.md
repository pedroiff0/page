...
> - **Data & Horário:** 19/11/2026 (Quinta-feira) · `14:00–17:00 / 16:40–20:10 (4 tempos)`
> - **Tópico Central:** Gestão de Riscos em Projetos: Identificação e Matriz de Probabilidade
> - **Status das Anotações:** 🟢 Planejada & Estruturada

> [!note] 📦 Material Didático e Recursos da Aula
> ### 📑 Material de Apoio
> - 📄 **[Slides da Aula (PDF)](/assets/disciplinas/6-periodo/gestao-de-projetos/slides-aula-12.pdf)** — *Apresentação e notas do docente.*
...
## 📋 Sumário Interativo
- [📍 1. Anotações do Quadro: Gestão de Riscos em Projetos: Identificação e Matriz de Probabilidade](#-1-anotações-do-quadro-gestao-de-riscos-em-projetos-identificacao-e-matriz-de-probabilidade)
...
## 📌 1. Anotações do Quadro: Gestão de Riscos em Projetos: Identificação e Matriz de Probabilidade

### 📐 Fundamentação Teórica
Identificação de riscos, análise qualitativa (Matriz de Impacto e Probabilidade), plano de resposta (mitigar, aceitar, transferir, evitar).
...
Desenvolva a solução para a aplicação prática de **Gestão de Riscos em Projetos: Identificação e Matriz de Probabilidade**:
...
> Sempre revise as premissas iniciais e condições de contorno de **Gestão de Riscos em Projetos: Identificação e Matriz de Probabilidade** antes de simplificar as equações na prova!
...
```mermaid
flowchart TD
    A[Entrada: Gestão de Riscos em Projetos: Identificação e Matriz de Probabilidade] --> B[Processamento & Análise Técnica]
...
| :--- | :--- | :--- |
| **Gestão de Riscos em Projetos: Identificação e Matriz de Probabilidade** | Aplicação direta de Gestão de Projetos | Verificar restrições de contorno |

---

## 📝 5. Dúvidas & Exercícios Recomendados para Casa

- [ ] Exercício 01: Resolver as questões do quadro sobre **Gestão de Riscos em Projetos: Identificação e Matriz de Probabilidade**.
