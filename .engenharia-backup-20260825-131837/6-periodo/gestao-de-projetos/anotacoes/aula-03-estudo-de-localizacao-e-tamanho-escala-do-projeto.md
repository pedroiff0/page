...
> - **Data & Horário:** 17/09/2026 (Quinta-feira) · `14:00–17:00 / 16:40–20:10 (4 tempos)`
> - **Tópico Central:** Estudo de Localização e Tamanho/Escala do Projeto
> - **Status das Anotações:** 🟢 Planejada & Estruturada

> [!note] 📦 Material Didático e Recursos da Aula
> ### 📑 Material de Apoio
> - 📄 **[Slides da Aula (PDF)](/assets/disciplinas/6-periodo/gestao-de-projetos/slides-aula-03.pdf)** — *Apresentação e notas do docente.*
...
## 📋 Sumário Interativo
- [📍 1. Anotações do Quadro: Estudo de Localização e Tamanho/Escala do Projeto](#-1-anotações-do-quadro-estudo-de-localizacao-e-tamanho-escala-do-projeto)
...
## 📌 1. Anotações do Quadro: Estudo de Localização e Tamanho/Escala do Projeto

### 📐 Fundamentação Teórica
Fatores locacionais qualitativos e quantitativos (Método dos Pesos Ponderados), escala produtiva e curva de aprendizagem.
...
Desenvolva a solução para a aplicação prática de **Estudo de Localização e Tamanho/Escala do Projeto**:
...
> Sempre revise as premissas iniciais e condições de contorno de **Estudo de Localização e Tamanho/Escala do Projeto** antes de simplificar as equações na prova!
...
```mermaid
flowchart TD
    A[Entrada: Estudo de Localização e Tamanho/Escala do Projeto] --> B[Processamento & Análise Técnica]
...
| :--- | :--- | :--- |
| **Estudo de Localização e Tamanho/Escala do Projeto** | Aplicação direta de Gestão de Projetos | Verificar restrições de contorno |

---

## 📝 5. Dúvidas & Exercícios Recomendados para Casa

- [ ] Exercício 01: Resolver as questões do quadro sobre **Estudo de Localização e Tamanho/Escala do Projeto**.
