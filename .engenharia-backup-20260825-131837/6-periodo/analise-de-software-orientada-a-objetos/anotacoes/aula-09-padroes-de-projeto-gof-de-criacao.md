...
> - **Data & Horário:** 28/10/2026 (Quarta-feira) · `13:40–16:30 (3 tempos)`
> - **Tópico Central:** Padrões de Projeto GoF de Criação
> - **Status das Anotações:** 🟢 Planejada & Estruturada

> [!note] 📦 Material Didático e Recursos da Aula
> ### 📑 Material de Apoio
> - 📄 **[Slides da Aula (PDF)](/assets/disciplinas/6-periodo/analise-de-software-orientada-a-objetos/slides-aula-09.pdf)** — *Apresentação e notas do docente.*
...
## 📋 Sumário Interativo
- [📍 1. Anotações do Quadro: Padrões de Projeto GoF de Criação](#-1-anotações-do-quadro-padroes-de-projeto-gof-de-criacao)
...
## 📌 1. Anotações do Quadro: Padrões de Projeto GoF de Criação

### 📐 Fundamentação Teórica
Padrões de Criação: Factory Method, Abstract Factory, Singleton, Builder e Prototype aplicados na prática.
...
Desenvolva a solução para a aplicação prática de **Padrões de Projeto GoF de Criação**:
...
> Sempre revise as premissas iniciais e condições de contorno de **Padrões de Projeto GoF de Criação** antes de simplificar as equações na prova!
...
```mermaid
flowchart TD
    A[Entrada: Padrões de Projeto GoF de Criação] --> B[Processamento & Análise Técnica]
...
| :--- | :--- | :--- |
| **Padrões de Projeto GoF de Criação** | Aplicação direta de Análise de Software Orientada a Objetos | Verificar restrições de contorno |

---

## 📝 5. Dúvidas & Exercícios Recomendados para Casa

- [ ] Exercício 01: Resolver as questões do quadro sobre **Padrões de Projeto GoF de Criação**.
