...
> - **Data & Horário:** 30/11/2026 (Segunda-feira) · `16:40–19:20 (3 tempos)`
> - **Tópico Central:** Máquinas de Estados Finitos (FSM): Modelos de Mealy e Moore
> - **Status das Anotações:** 🟢 Planejada & Estruturada

> [!note] 📦 Material Didático e Recursos da Aula
> ### 📑 Material de Apoio
> - 📄 **[Slides da Aula (PDF)](/assets/disciplinas/6-periodo/eletronica-digital/slides-aula-14.pdf)** — *Apresentação e notas do docente.*
...
## 📋 Sumário Interativo
- [📍 1. Anotações do Quadro: Máquinas de Estados Finitos (FSM): Modelos de Mealy e Moore](#-1-anotações-do-quadro-maquinas-de-estados-finitos-fsm-modelos-de-mealy-e-moore)
...
## 📌 1. Anotações do Quadro: Máquinas de Estados Finitos (FSM): Modelos de Mealy e Moore

### 📐 Fundamentação Teórica
Diferenças de temporização e saídas síncronas/assíncronas, minimização de estados e síntese em FPGA/CPLD.
...
Desenvolva a solução para a aplicação prática de **Máquinas de Estados Finitos (FSM): Modelos de Mealy e Moore**:
...
> Sempre revise as premissas iniciais e condições de contorno de **Máquinas de Estados Finitos (FSM): Modelos de Mealy e Moore** antes de simplificar as equações na prova!
...
```mermaid
flowchart TD
    A[Entrada: Máquinas de Estados Finitos (FSM): Modelos de Mealy e Moore] --> B[Processamento & Análise Técnica]
...
| :--- | :--- | :--- |
| **Máquinas de Estados Finitos (FSM): Modelos de Mealy e Moore** | Aplicação direta de Eletrônica Digital | Verificar restrições de contorno |

---

## 📝 5. Dúvidas & Exercícios Recomendados para Casa

- [ ] Exercício 01: Resolver as questões do quadro sobre **Máquinas de Estados Finitos (FSM): Modelos de Mealy e Moore**.
